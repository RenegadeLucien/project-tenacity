...
public enum Achievement {
    ...
    COURSING_THROUGH_YOU("Coursing Through You", 0, Collections.singletonList(new Requirement("Max Telos enrage", 95)),
            Collections.singletonList(new Encounter(Collections.singletonList(Enemy.TELOS_100_ENRAGE))), new ArrayList<>(), new ArrayList<>(), true),
    ...
    DISOWNED("Disowned", 0, Arrays.asList(new Requirement("Reforged Sunspear", 1), new Requirement("House Drakan hood", 1),
            ...
            new Requirement("House Drakan boots", 1)), Collections.singletonList(new Encounter(Arrays.asList(Enemy.VANSTROM_KLAUSE,
            Enemy.VANSTROM_KLAUSE))), new ArrayList<>(), new ArrayList<>(), true),
    ...
    DONT_FEAR_THE_RIPPER("Don't Fear the Ripper", 0, Collections.singletonList(new Requirement("Miner's journals", 6)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DOUBLE_SWOOP("Double Swoop", 0, Collections.singletonList(new Requirement("Ranged", 70)), Collections.singletonList(new Encounter(Arrays.asList(Enemy.FLIGHT_KILISA,
            Enemy.WINGMAN_SKREE, Enemy.FLOCKLEADER_GEERIN, Enemy.FLIGHT_KILISA, Enemy.WINGMAN_SKREE, Enemy.FLOCKLEADER_GEERIN,
            Enemy.KREEARRA))), new ArrayList<>(), new ArrayList<>(), true),
    ...
    DUKES_OF_KHAZARD("Dukes of Khazard", 0, new ArrayList<>(), Collections.singletonList(new Encounter(Collections.singletonList(Enemy.GNOME_TROOP))),
            new ArrayList<>(), new ArrayList<>(), true),
    ...
    FINAL_BOSS("Final Boss", 0, Arrays.asList(new Requirement("Who's the Boss? VI", 1), new Requirement("General Mayhem VI", 1),
            ...
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FINISH_HIM("Finish Him!", 0, new ArrayList<>(), Collections.singletonList(new Encounter(Collections.singletonList(Enemy.VORAGO))),
            new ArrayList<>(), new ArrayList<>(), true),
    ...
    FIST_CONTACT("Fist Contact", 0, Collections.singletonList(new Requirement("Strength", 70)),
            Collections.singletonList(new Encounter(Collections.singletonList(Enemy.GENERAL_GRAARDOR))), new ArrayList<>(),
            new ArrayList<>(), true),
    ...
    FLOOR_IS_LARVAL("Floor is Larval", 0, Collections.singletonList(new Requirement("Summoning", 60)),
            Collections.singletonList(new Encounter(Arrays.asList(Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM,
                    Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM,
                    Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM,
                    Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM,
                    Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.GIANT_WORM,
                    Enemy.GIANT_WORM, Enemy.GIANT_WORM, Enemy.QUEEN_BLACK_DRAGON))), new ArrayList<>(), new ArrayList<>(), true),
