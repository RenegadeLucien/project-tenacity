...
public enum Achievement {
	...
	AGILITY_99("Agility 99", 0, Collections.singletonList(new Requirement("Agility", 99)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	AHRIM_BOBBLEHEAD("Ahrim Bobblehead", 0, Collections.singletonList(new Requirement("Ahrim the Bobbled", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    DHAROK_BOBBLEHEAD("Dharok Bobblehead", 0, Collections.singletonList(new Requirement("Dharok the Bobbled", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DIARIES_OF_THE_CLANS("Diaries of the Clans", 0, Collections.singletonList(new Requirement("Voice of the Elders", 8)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DIARY_OF_OREB("Diary of Oreb", 0, Collections.singletonList(new Requirement("The Magister's Journals", 5)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DIARY_OF_THE_GODS("Diary of the Gods", 0, Collections.singletonList(new Requirement("God journals", 5)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DIDDYZAG("Diddyzag", 0, Collections.singletonList(new Requirement("Diddyzag", 1)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DISHONOURABLE_GAINS("Dishonourable Gains", 0, Collections.singletonList(new Requirement("Zamorak hideout XP chests", 3)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DISHONOURABLE_LOOT("Dishonourable Gains", 0, Collections.singletonList(new Requirement("Zamorak hideout loot chests", 6)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    DIVINATION_WILLOW("Divination - Willow", 0, Collections.singletonList(new Requirement("Willow", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    DIVINATION_5("Divination 5", 0, Collections.singletonList(new Requirement("Divination", 5)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_10("Divination 10", 0, Collections.singletonList(new Requirement("Divination", 10)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_20("Divination 20", 0, Collections.singletonList(new Requirement("Divination", 20)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_30("Divination 30", 0, Collections.singletonList(new Requirement("Divination", 30)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_40("Divination 40", 0, Collections.singletonList(new Requirement("Divination", 40)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_50("Divination 50", 0, Collections.singletonList(new Requirement("Divination", 50)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_60("Divination 60", 0, Collections.singletonList(new Requirement("Divination", 60)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_70("Divination 70", 0, Collections.singletonList(new Requirement("Divination", 70)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_80("Divination 80", 0, Collections.singletonList(new Requirement("Divination", 80)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_90("Divination 90", 0, Collections.singletonList(new Requirement("Divination", 90)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_92("Divination 92", 0, Collections.singletonList(new Requirement("Divination", 92)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINATION_99("Divination 99", 0, Collections.singletonList(new Requirement("Divination", 99)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DIVINE_RETRIBUTION("Divine Retribution", 0, Arrays.asList(new Requirement("Business Is Booning", 1),
            ...
            new ArrayList<>(), true),
    DO_NO_ELITE("Do No Elite", 0, Collections.singletonList(new Requirement("Do No Evil elite clue", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DO_A_MINION_TAKE_NOTES("Do a Minion, Take Notes", 0, Collections.singletonList(new Requirement("Dominion page", 20)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    DONT_FEAR_THE_RIPPER("Don't Fear the Ripper", 0, Collections.singletonList(new Requirement("Miner's journals", 6)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DOUBLE_SWOOP("Double Swoop", 0, Collections.singletonList(new Requirement("Ranged", 70)), Collections
			.singletonList(new Encounter(Arrays.asList(Arrays.asList(Enemy.FLIGHT_KILISA, Enemy.WINGMAN_SKREE, Enemy.FLOCKLEADER_GEERIN),
					...
					new ArrayList<>())), new ArrayList<>(), new ArrayList<>(), true),
    DRAGONKIN_LOGS("Dragonkin Logs", 0, Collections.singletonList(new Requirement("Dragonkin journals", 4)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DRAYNOR("Draynor", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    DUKES_OF_KHAZARD("Dukes of Khazard", 0, new ArrayList<>(), Collections.singletonList(new Encounter(Collections.singletonList(Collections.singletonList(Enemy.GNOME_TROOP)),
			new ArrayList<>())), new ArrayList<>(), new ArrayList<>(), true),
    DUNGEONEERING_GORDIE("Dungeoneering - Gordie", 0, Collections.singletonList(new Requirement("Gordie", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    DUNGEONEERING_5("Dungeoneering 5", 0, Collections.singletonList(new Requirement("Dungeoneering", 5)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_10("Dungeoneering 10", 0, Collections.singletonList(new Requirement("Dungeoneering", 10)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_20("Dungeoneering 20", 0, Collections.singletonList(new Requirement("Dungeoneering", 20)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_30("Dungeoneering 30", 0, Collections.singletonList(new Requirement("Dungeoneering", 30)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_40("Dungeoneering 40", 0, Collections.singletonList(new Requirement("Dungeoneering", 40)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_50("Dungeoneering 50", 0, Collections.singletonList(new Requirement("Dungeoneering", 50)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_60("Dungeoneering 60", 0, Collections.singletonList(new Requirement("Dungeoneering", 60)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_70("Dungeoneering 70", 0, Collections.singletonList(new Requirement("Dungeoneering", 70)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_80("Dungeoneering 80", 0, Collections.singletonList(new Requirement("Dungeoneering", 80)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_90("Dungeoneering 90", 0, Collections.singletonList(new Requirement("Dungeoneering", 90)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_99("Dungeoneering 99", 0, Collections.singletonList(new Requirement("Dungeoneering", 99)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_110("Dungeoneering 110", 0, Collections.singletonList(new Requirement("Dungeoneering", 110)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUNGEONEERING_120("Dungeoneering 120", 0, Collections.singletonList(new Requirement("Dungeoneering", 120)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    DUSTING_MURIAL("Dusting Murial", 0, Collections.singletonList(new Requirement("Dusted murals", 2)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    EAGLES_PEAK("Eagles' Peak", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    EASTERN_ADVENTURER("Eastern Adventurer", 0, Collections.singletonList(new Requirement("Port storylines", 4)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    EASTERN_EXPLORER("Eastern Explorer", 0, Collections.singletonList(new Requirement("The Shield region", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    EAT_TO_LIVE("Eat to Live", 0, Collections.singletonList(new Requirement("Sardine", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    EDGEVILLE("Edgeville", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    EEEAGLE("Eeeeagle!", 0, Collections.singletonList(new Requirement("Eagle transport routes", 5)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ELEMENTAL_KILL_CHAOS_I("Elemental Kill Chaos I", 0, Collections.singletonList(new Requirement("Chaos Elemental", 5)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ELEMENTAL_KILL_CHAOS_II("Elemental Kill Chaos II", 0, Collections.singletonList(new Requirement("Chaos Elemental", 10)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ELEMENTAL_KILL_CHAOS_III("Elemental Kill Chaos III", 0, Collections.singletonList(new Requirement("Chaos Elemental", 25)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ELEMENTAL_KILL_CHAOS_IV("Elemental Kill Chaos IV", 0, Collections.singletonList(new Requirement("Chaos Elemental", 50)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ELEMENTAL_KILL_CHAOS_V("Elemental Kill Chaos V", 0, Collections.singletonList(new Requirement("Chaos Elemental", 75)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ELEMENTAL_KILL_CHAOS_VI("Elemental Kill Chaos VI", 0, Collections.singletonList(new Requirement("Chaos Elemental", 100)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ELLIE("Ellie", 0, Collections.singletonList(new Requirement("Ellie", 1)), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ELVEN_TITLES("Elven Titles", 0, Collections.singletonList(new Requirement("Elf City titles", 8)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ...
    ENOUGH_OF_THE_CRAZY_WALKING("Enough of the Crazy Walking", 0, Collections.singletonList(new Requirement("Mad Ramblings", 2)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    ESSENTIAL_FACILITATOR("Essential Facilitator", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    EVERYBODY_LOVES_COAL("Everybody Loves Coal", 0, Collections.singletonList(new Requirement("Mining", 30)),
            ...
            new ArrayList<>(), true),
    EXILED("Exiled", 0, Collections.singletonList(new Requirement("Kalphite King uniques", 8)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    EXPERIENCE_THE_FATE_OF_THE_GODS("Experience the Fate of the Gods", 0, Collections.singletonList(new Requirement("Post-Fate of the Gods lamps", 4)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    EXPLORE_FOR_NESTOR("Explore for Nestor", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FACELESS_AND_READY("Faceless and Ready", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FALADOR("Falador", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    FALLEN_ANGEL("Fallen Angel", 0, Collections.singletonList(new Requirement("Angel of Death uniques", 10)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FAMILY_AFFAIR("Family Affair", 0, Collections.singletonList(new Requirement("Rise of the Six uniques", 10)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    ...
    FARMING_BRAINS("Farming - Brains", 0, Collections.singletonList(new Requirement("Brains", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FARMING_5("Farming 5", 0, Collections.singletonList(new Requirement("Farming", 5)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_10("Farming 10", 0, Collections.singletonList(new Requirement("Farming", 10)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_20("Farming 20", 0, Collections.singletonList(new Requirement("Farming", 20)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_30("Farming 30", 0, Collections.singletonList(new Requirement("Farming", 30)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_40("Farming 40", 0, Collections.singletonList(new Requirement("Farming", 40)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_50("Farming 50", 0, Collections.singletonList(new Requirement("Farming", 50)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_60("Farming 60", 0, Collections.singletonList(new Requirement("Farming", 60)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_70("Farming 70", 0, Collections.singletonList(new Requirement("Farming", 70)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_80("Farming 80", 0, Collections.singletonList(new Requirement("Farming", 80)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_90("Farming 90", 0, Collections.singletonList(new Requirement("Farming", 90)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_92("Farming 92", 0, Collections.singletonList(new Requirement("Farming", 92)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FARMING_99("Farming 99", 0, Collections.singletonList(new Requirement("Farming", 99)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FAST_AND_FURIOUS_I("Fast and Furious I", 0, Collections.singletonList(new Requirement("Twin Furies", 5)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FAST_AND_FURIOUS_II("Fast and Furious II", 0, Collections.singletonList(new Requirement("Twin Furies", 10)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FAST_AND_FURIOUS_III("Fast and Furious III", 0, Collections.singletonList(new Requirement("Twin Furies", 25)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FAST_AND_FURIOUS_IV("Fast and Furious IV", 0, Collections.singletonList(new Requirement("Twin Furies", 50)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FAST_AND_FURIOUS_V("Fast and Furious V", 0, Collections.singletonList(new Requirement("Twin Furies", 75)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FAST_AND_FURIOUS_VI("Fast and Furious VI", 0, Collections.singletonList(new Requirement("Twin Furies", 100)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FEROCIOUS_UPGRADE("Ferocious Upgrade", 0, Arrays.asList(new Requirement("Slayer", 90), new Requirement("Slayer point", 100)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FINAL_BOSS("Final Boss", 0, Arrays.asList(new Requirement("Who's the Boss? VI", 1), new Requirement("General Mayhem VI", 1),
            ...
            new Requirement("Bug Zapper VI", 1), new Requirement("Brass Nex VI", 1), new Requirement("Master of Beatings VI", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FINISH_HIM("Finish Him!", 0, new ArrayList<>(), Collections.singletonList(new Encounter(Collections.singletonList(Collections.singletonList(Enemy.VORAGO)),
			new ArrayList<>())), new ArrayList<>(), new ArrayList<>(), true),
    FIREMAKING_BERNIE("Firemaking - Bernie", 0, Collections.singletonList(new Requirement("Bernie", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FIREMAKING_5("Firemaking 5", 0, Collections.singletonList(new Requirement("Firemaking", 5)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_10("Firemaking 10", 0, Collections.singletonList(new Requirement("Firemaking", 10)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_20("Firemaking 20", 0, Collections.singletonList(new Requirement("Firemaking", 20)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_30("Firemaking 30", 0, Collections.singletonList(new Requirement("Firemaking", 30)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_40("Firemaking 40", 0, Collections.singletonList(new Requirement("Firemaking", 40)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_50("Firemaking 50", 0, Collections.singletonList(new Requirement("Firemaking", 50)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_60("Firemaking 60", 0, Collections.singletonList(new Requirement("Firemaking", 60)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_70("Firemaking 70", 0, Collections.singletonList(new Requirement("Firemaking", 70)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_80("Firemaking 80", 0, Collections.singletonList(new Requirement("Firemaking", 80)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_90("Firemaking 90", 0, Collections.singletonList(new Requirement("Firemaking", 90)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_92("Firemaking 92", 0, Collections.singletonList(new Requirement("Firemaking", 92)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIREMAKING_99("Firemaking 99", 0, Collections.singletonList(new Requirement("Firemaking", 99)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
	FIRES_ARE_MOSTLY_HARMLESS("Fires are Mostly Harmless", 0, Collections.singletonList(new Requirement("Fairy Tale III post-quest rewards", 2)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FIRST_RULE_OF_FIGHT_CAVES("First Rule of Fight Caves", 0, Collections.singletonList(new Requirement("TzHaar uniques", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    FISHING_BUBBLES("Fishing - Bubbles", 0, Collections.singletonList(new Requirement("Bubbles", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FISHING_5("Fishing 5", 0, Collections.singletonList(new Requirement("Fishing", 5)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_10("Fishing 10", 0, Collections.singletonList(new Requirement("Fishing", 10)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_20("Fishing 20", 0, Collections.singletonList(new Requirement("Fishing", 20)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_30("Fishing 30", 0, Collections.singletonList(new Requirement("Fishing", 30)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_40("Fishing 40", 0, Collections.singletonList(new Requirement("Fishing", 40)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_50("Fishing 50", 0, Collections.singletonList(new Requirement("Fishing", 50)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_60("Fishing 60", 0, Collections.singletonList(new Requirement("Fishing", 60)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_70("Fishing 70", 0, Collections.singletonList(new Requirement("Fishing", 70)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_80("Fishing 80", 0, Collections.singletonList(new Requirement("Fishing", 80)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_90("Fishing 90", 0, Collections.singletonList(new Requirement("Fishing", 90)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_92("Fishing 92", 0, Collections.singletonList(new Requirement("Fishing", 92)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FISHING_99("Fishing 99", 0, Collections.singletonList(new Requirement("Fishing", 99)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FIST_CONTACT("Fist Contact", 0, Collections.singletonList(new Requirement("Strength", 70)),
			...
			new ArrayList<>(), new ArrayList<>(), true),
    FIVE_STAR_GENERAL("Five-Star General", 0, Collections.singletonList(new Requirement("General Graardor uniques", 18)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FLETCHING_FLO("Fletching - Flo", 0, Collections.singletonList(new Requirement("Flo", 1)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FLETCHING_5("Fletching 5", 0, Collections.singletonList(new Requirement("Fletching", 5)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_10("Fletching 10", 0, Collections.singletonList(new Requirement("Fletching", 10)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_20("Fletching 20", 0, Collections.singletonList(new Requirement("Fletching", 20)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_30("Fletching 30", 0, Collections.singletonList(new Requirement("Fletching", 30)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_40("Fletching 40", 0, Collections.singletonList(new Requirement("Fletching", 40)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_50("Fletching 50", 0, Collections.singletonList(new Requirement("Fletching", 50)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_60("Fletching 60", 0, Collections.singletonList(new Requirement("Fletching", 60)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_70("Fletching 70", 0, Collections.singletonList(new Requirement("Fletching", 70)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_80("Fletching 80", 0, Collections.singletonList(new Requirement("Fletching", 80)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_90("Fletching 90", 0, Collections.singletonList(new Requirement("Fletching", 90)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_92("Fletching 92", 0, Collections.singletonList(new Requirement("Fletching", 92)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLETCHING_99("Fletching 99", 0, Collections.singletonList(new Requirement("Fletching", 99)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    FLOOR_IS_LARVAL("Floor is Larval", 0, Collections.singletonList(new Requirement("Summoning", 60)),
			...
			new ArrayList<>(), new ArrayList<>(), true),
    FOR_THE_LOVE_OF_MABEL("For the Love of Mabel", 0, Collections.singletonList(new Requirement("Love Story post-quest rewards", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FORCAES_METTLE("Forcae's Mettle", 0, Collections.singletonList(new Requirement("Forcae's journal page", 10)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    FREDS_SHEARINGS("Fred's Shearings", 0, Collections.singletonList(new Requirement("Sheep Shearer", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    FREMENNIK_PROVINCE("Fremennik Province", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    FRIENDS_WITH_MAX("Friends with Max", 0, Arrays.asList(new Requirement("Agility", 99), new Requirement("Attack", 99),
            ...
            new Requirement("Invention", 99)), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    GAME_OVER("Game Over", 0, Collections.singletonList(new Requirement("Gregorovic uniques", 8)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_AWWDOR("General Awwdor", 0, Collections.singletonList(new Requirement("General Awwdor", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_DISASTER_I("General Disaster I", 0, Collections.singletonList(new Requirement("General Graardor (hard)", 5)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_DISASTER_II("General Disaster II", 0, Collections.singletonList(new Requirement("General Graardor (hard)", 10)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_DISASTER_III("General Disaster III", 0, Collections.singletonList(new Requirement("General Graardor (hard)", 25)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_DISASTER_IV("General Disaster IV", 0, Collections.singletonList(new Requirement("General Graardor (hard)", 50)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_DISASTER_V("General Disaster V", 0, Collections.singletonList(new Requirement("General Graardor (hard)", 75)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_DISASTER_VI("General Disaster VI", 0, Collections.singletonList(new Requirement("General Graardor (hard)", 100)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_MAYHEM_I("General Mayhem I", 0, Collections.singletonList(new Requirement("General Graardor", 5)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_MAYHEM_II("General Mayhem II", 0, Collections.singletonList(new Requirement("General Graardor", 10)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_MAYHEM_III("General Mayhem III", 0, Collections.singletonList(new Requirement("General Graardor", 25)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_MAYHEM_IV("General Mayhem IV", 0, Collections.singletonList(new Requirement("General Graardor", 50)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_MAYHEM_V("General Mayhem V", 0, Collections.singletonList(new Requirement("General Graardor", 75)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GENERAL_MAYHEM_VI("General Mayhem VI", 0, Collections.singletonList(new Requirement("General Graardor", 100)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GIFT_FROM_SLISKE("Gift from Sliske", 0, Collections.singletonList(new Requirement("Sliske after-quest tasks", 2)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    GLUTTON_FOR_PUNISHMENT("Glutton for Punishment", 0, Arrays.asList(new Requirement("Dreadfowl pouch", 1),
            ...
            new Requirement("Summoning", 74)), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    GOD_WARS_DUNGEON_TELEPORT("God Wars Dungeon Teleport", 0, Arrays.asList(new Requirement("The Mighty Fall", 1), new Requirement("Law rune", 2),
            new Requirement("Fire rune", 2), new Requirement("Magic", 61)), new ArrayList<>(), Collections.singletonList(new Reward("Magic", 68)),
            new ArrayList<>(), true),
    GOEBIE_RELICS("Goebie Relics", 0, Collections.singletonList(new Requirement("Stone fragments", 5)), new ArrayList<>(),
            new ArrayList<>(), new ArrayList<>(), true),
    GOING_DOWN_WITH_THE_SHIP("Going Down with the Ship", 0.2, Collections.singletonList(new Requirement("Fishing", 15)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    ...
    GOING_ON_A_SUMMER_HOLIDAY("Going on a Summer Holidat", 0, Collections.singletonList(new Requirement("Coins", 30)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
    GONE_FISHING("Gone Fishing", 0, Collections.singletonList(new Requirement("Fishing", 15)), new ArrayList<>(), new ArrayList<>(),
            new ArrayList<>(), true),
    ...
    GOT_A_VYRE_REPUTATION("Got a Vyre Reputation", 0, Collections.singletonList(new Requirement("Maximum vyre reputation", 1)),
            new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	...
	GREAT_GIELINOR_RUN("Great Gielinor Run", 0.25, Arrays.asList(new Requirement("The Branches of Darkmeyer", 1),
			new Requirement("Regicide", 1)), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	GREG("Greg", 0, Collections.singletonList(new Requirement("Greg", 1)), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	GREGOREY_I("Gregore-Y I", 0, Collections.singletonList(new Requirement("Gregorovic (hard)", 5)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGOREY_II("Gregore-Y II", 0, Collections.singletonList(new Requirement("Gregorovic (hard)", 10)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGOREY_III("Gregore-Y III", 0, Collections.singletonList(new Requirement("Gregorovic (hard)", 25)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGOREY_IV("Gregore-Y IV", 0, Collections.singletonList(new Requirement("Gregorovic (hard)", 50)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGOREY_V("Gregore-Y V", 0, Collections.singletonList(new Requirement("Gregorovic (hard)", 75)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGOREY_VI("Gregore-Y VI", 0, Collections.singletonList(new Requirement("Gregorovic (hard)", 100)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGORGEOUS_I("Gregorgeous I", 0, Collections.singletonList(new Requirement("Gregorovic", 5)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGORGEOUS_II("Gregorgeous II", 0, Collections.singletonList(new Requirement("Gregorovic", 10)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGORGEOUS_III("Gregorgeous III", 0, Collections.singletonList(new Requirement("Gregorovic", 25)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGORGEOUS_IV("Gregorgeous IV", 0, Collections.singletonList(new Requirement("Gregorovic", 50)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGORGEOUS_V("Gregorgeous V", 0, Collections.singletonList(new Requirement("Gregorovic", 75)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	GREGORGEOUS_VI("Gregorgeous VI", 0, Collections.singletonList(new Requirement("Gregorovic", 100)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
    ...
    GRONDABANS_LEGACY("Grondaban's legacy", 0, Collections.singletonList(new Requirement("Dishonour among Thieves", 1)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	...
	GUNNING_FOR_JEWELLERY("Gunning for Jewellery", 0, Collections.singletonList(new Requirement("Dororan's jewellery", 3)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	GUTHAN_BOBBLEHEAD("Guthan Bobblehead", 0, Collections.singletonList(new Requirement("Guthan the Bobbled", 1)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HAIL_TO_THE_QUEEN("Hail to the Queen", 0, new ArrayList<>(), Collections.singletonList(new Encounter(Arrays.asList(Arrays.asList(Enemy.KALPHITE_GUARDIAN,
			...
			new ArrayList<>())), new ArrayList<>(), new ArrayList<>(), true),
	HAIL_TO_THE_DUKE_BABY("Hail to the Duke, Baby", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	...
	HANDICRAFTS("Handicrafts", 0, Arrays.asList(new Requirement("Thread", 1), new Requirement("Leather", 1)),
			...
			new ArrayList<>(), true),
	HANG_ON_TO_SOMETHING("Hang On to Something", 0, new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HAPPY_HOUR("Happy Hour", 0, Collections.singletonList(new Requirement("Cider", 5)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HARD_AS_DAEMONS("Hard As Daemons", 0, Collections.singletonList(new Requirement("Hard mode floors", 60)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HARD_AS_A_ROCK("Hard as a Rock", 0, Collections.singletonList(new Requirement("Vorago uniques", 11)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HARDLY_A_CHALLENGE_I("Hardly a Challenge I", 0, Collections.singletonList(new Requirement("Har-Aken", 5)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HARDLY_A_CHALLENGE_II("Hardly a Challenge II", 0, Collections.singletonList(new Requirement("Har-Aken", 10)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HARDLY_A_CHALLENGE_III("Hardly a Challenge III", 0, Collections.singletonList(new Requirement("Har-Aken", 25)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HARDLY_A_CHALLENGE_IV("Hardly a Challenge IV", 0, Collections.singletonList(new Requirement("Har-Aken", 50)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HARDLY_A_CHALLENGE_V("Hardly a Challenge V", 0, Collections.singletonList(new Requirement("Har-Aken", 75)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HARDLY_A_CHALLENGE_VI("Hardly a Challenge VI", 0, Collections.singletonList(new Requirement("Har-Aken", 100)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HAUL_COMES_TO_TEMPLETON("Haul Comes to Templeton", 0.05, Collections.singletonList(new Requirement("Dealing with Scabaras", 1)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HEAL_QUICKLY("Heal, Quickly", 0, Collections.singletonList(new Requirement("Rapid Renewal", 1)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HEART_TO_HEART("Heart to Heart", 0, Collections.singletonList(new Requirement("Twin Furies uniques", 9)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HEL_IN_A_HANDBASKET_I("Hel in a Handbasket I", 0, Collections.singletonList(new Requirement("Helwyr (challenge mode)", 5)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HEL_IN_A_HANDBASKET_II("Hel in a Handbasket II", 0, Collections.singletonList(new Requirement("Helwyr (challenge mode)", 10)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HEL_IN_A_HANDBASKET_III("Hel in a Handbasket III", 0, Collections.singletonList(new Requirement("Helwyr (challenge mode)", 25)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HEL_IN_A_HANDBASKET_IV("Hel in a Handbasket IV", 0, Collections.singletonList(new Requirement("Helwyr (challenge mode)", 50)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HEL_IN_A_HANDBASKET_V("Hel in a Handbasket V", 0, Collections.singletonList(new Requirement("Helwyr (challenge mode)", 75)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HEL_IN_A_HANDBASKET_VI("Hel in a Handbasket VI", 0, Collections.singletonList(new Requirement("Helwyr (challenge mode)", 100)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	...
	HERBLORE_HERBERT("Herblore - Herbert", 0, Collections.singletonList(new Requirement("Herbert", 1)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HERBLORE_5("Herblore 5", 0, Collections.singletonList(new Requirement("Herblore", 5)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_10("Herblore 10", 0, Collections.singletonList(new Requirement("Herblore", 10)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_20("Herblore 20", 0, Collections.singletonList(new Requirement("Herblore", 20)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_30("Herblore 30", 0, Collections.singletonList(new Requirement("Herblore", 30)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_40("Herblore 40", 0, Collections.singletonList(new Requirement("Herblore", 40)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_50("Herblore 50", 0, Collections.singletonList(new Requirement("Herblore", 50)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_60("Herblore 60", 0, Collections.singletonList(new Requirement("Herblore", 60)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_70("Herblore 70", 0, Collections.singletonList(new Requirement("Herblore", 70)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_80("Herblore 80", 0, Collections.singletonList(new Requirement("Herblore", 80)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_90("Herblore 90", 0, Collections.singletonList(new Requirement("Herblore", 90)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_92("Herblore 92", 0, Collections.singletonList(new Requirement("Herblore", 92)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HERBLORE_99("Herblore 99", 0, Collections.singletonList(new Requirement("Herblore", 99)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	...
	HERE_WE_RAGO_AGAIN_I("Here We Rago Again I", 0, Collections.singletonList(new Requirement("Vorago (hard)", 5)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HERE_WE_RAGO_AGAIN_II("Here We Rago Again II", 0, Collections.singletonList(new Requirement("Vorago (hard)", 10)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HERE_WE_RAGO_AGAIN_III("Here We Rago Again III", 0, Collections.singletonList(new Requirement("Vorago (hard)", 25)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HERE_WE_RAGO_AGAIN_IV("Here We Rago Again IV", 0, Collections.singletonList(new Requirement("Vorago (hard)", 50)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HERE_WE_RAGO_AGAIN_V("Here We Rago Again V", 0, Collections.singletonList(new Requirement("Vorago (hard)", 75)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HERE_WE_RAGO_AGAIN_VI("Here We Rago Again VI", 0, Collections.singletonList(new Requirement("Vorago (hard)", 100)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HERO_OF_THE_GOEBIES("Hero of the Goebies", 0, Arrays.asList(new Requirement("All Together Now", 1),
			...
			new Requirement("Rewind", 1)), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	...
	HISTORY_OF_BILRACH("History of Bilrach", 0, Collections.singletonList(new Requirement("Mysterious chronicle", 30)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HONESTLY_ITS_NOT_A_PURSE("Honestly, It's Not a Purse", 0, Arrays.asList(new Requirement("Giant pouch", 1),
			new Requirement("Pure essence", 1)), new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HOW_MANY_GAMES("How Many Games?", 0, Arrays.asList(new Requirement("Profound helmet", 1),
			...
			new Requirement("Profound sword", 1), new Requirement("Profound shield", 1)),
			new ArrayList<>(),  new ArrayList<>(), new ArrayList<>(), true),
	HOW_TO_SHAME_YOUR_DRAGON("How to Shame Your Dragon", 0, Collections.singletonList(new Requirement("King Black Dragon uniques", 1)),
			new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), true),
	HUNGRY_HUNGRY_REAVERS("Hungry Hungry Reavers", 0, Collections.singletonList(new Requirement("Frozen key", 1)),
			...
			new ArrayList<>(), new ArrayList<>(), true),
	HUNTER_ACE("Hunter - Ace", 0, Collections.singletonList(new Requirement("Ace", 1)), new ArrayList<>(),
			new ArrayList<>(), new ArrayList<>(), true),
	HUNTER_5("Hunter 5", 0, Collections.singletonList(new Requirement("Hunter", 5)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_10("Hunter 10", 0, Collections.singletonList(new Requirement("Hunter", 10)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_20("Hunter 20", 0, Collections.singletonList(new Requirement("Hunter", 20)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_30("Hunter 30", 0, Collections.singletonList(new Requirement("Hunter", 30)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_40("Hunter 40", 0, Collections.singletonList(new Requirement("Hunter", 40)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_50("Hunter 50", 0, Collections.singletonList(new Requirement("Hunter", 50)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_60("Hunter 60", 0, Collections.singletonList(new Requirement("Hunter", 60)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_70("Hunter 70", 0, Collections.singletonList(new Requirement("Hunter", 70)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_80("Hunter 80", 0, Collections.singletonList(new Requirement("Hunter", 80)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_90("Hunter 90", 0, Collections.singletonList(new Requirement("Hunter", 90)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_92("Hunter 92", 0, Collections.singletonList(new Requirement("Hunter", 92)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	HUNTER_99("Hunter 99", 0, Collections.singletonList(new Requirement("Hunter", 99)), new ArrayList<>(), new ArrayList<>(),
			new ArrayList<>(), true),
	;
	/* Quests
