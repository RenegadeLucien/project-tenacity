...
public enum Achievement {
    ...
    NEVER_EAT_SILK_WORMS(new AchievementBuilder("Never Eat Silk Worms", 0, true).encounter(new Encounter(Enemy.KALPHITE_KING))),
    NEW_VARROCK_SET_TASKS_EASY(new AchievementBuilder("New Varrock Set Tasks - Easy", 0, true).requirement("Hand Exchange", 1)
        .requirement("Trade Parade", 1).requirement("Hide and Seek", 1).requirement("Ready, Deady, Cook", 1).requirement("Pick One", 1)),
    NEW_VARROCK_SET_TASKS_ELITE(new AchievementBuilder("New Varrock Set Tasks - Elite", 1, true).requirement("Dark Imperator-ment", 1)
        .requirement("Changing of the Guard", 1).requirement("Steel, Stud, or Silk Salute", 1).requirement("Moo-er of All Bombs", 1)
        .requirement("Top Pick", 1)),
    NEW_VARROCK_SET_TASKS_HARD(new AchievementBuilder("New Varrock Set Tasks - Hard", 0, true).requirement("Bank-Z", 1)
        .requirement("Micro Brew", 1).requirement("Pick All", 1).requirement("South AND West Side Story", 1)
        .requirement("Mummy Returns", 1)),
    NEW_VARROCK_SET_TASKS_MEDIUM(new AchievementBuilder("New Varrock Set Tasks - Medium", 0, true).requirement("Cat's Bane", 1)
        .requirement("They Had a Gudrun", 1).requirement("Pick Half", 1).requirement("Scrying Game", 1).requirement("Tier Gear", 1)),
    NEX_PLS_I(new AchievementBuilder("Nex Pls I", 0, true).requirement("Nex: Angel of Death", 5)),
    NEX_PLS_II(new AchievementBuilder("Nex Pls II", 0, true).requirement("Nex: Angel of Death", 10)),
    NEX_PLS_III(new AchievementBuilder("Nex Pls III", 0, true).requirement("Nex: Angel of Death", 25)),
    NEX_PLS_IV(new AchievementBuilder("Nex Pls IV", 0, true).requirement("Nex: Angel of Death", 50)),
    NEX_PLS_V(new AchievementBuilder("Nex Pls V", 0, true).requirement("Nex: Angel of Death", 75)),
    NEX_PLS_VI(new AchievementBuilder("Nex Pls VI", 0, true).requirement("Nex: Angel of Death", 100)),
    NEXT_TO_NO_POWER(new AchievementBuilder("Next to No Power", 0, true).requirement("Frozen key", 1).encounter(new Encounter(Enemy.NEX,
        Collections.singletonList(new Restriction("Prayer", 0))))),
    NEXTERMINATOR(new AchievementBuilder("Nexterminator", 0, true).requirement("Blood-soaked feather", 1)),
    NO_TIME_TO_LOSE(new AchievementBuilder("No Time to Lose", 0, true).requirement("Ring of duelling", 1)),
    NOMADS_GENESIS(new AchievementBuilder("Nomad's Genesis", 0, true).requirement("Tales of Nomad", 1)),
    NOMADS_MIRAGE(new AchievementBuilder("Nomad's Mirage", 0, true).requirement("Memory of Nomad", 1)),
    NYLESSA(new AchievementBuilder("Nylessa", 0, true).requirement("Nymora's braid", 1)),
    OCELLUS_VIRIUS_NOTUS(new AchievementBuilder("Ocellus Virius Notus", 0, true).requirement("Order journal page", 22)),
    ON_A_MISSION_FROM_THE_GODS(new AchievementBuilder("On a Mission From...The Gods", 0, true).requirement("God Emissaries tasks", 15)),
    ON_A_RUNE_HIGH(new AchievementBuilder("On a Rune High", 0, true).requirement("Large rune casket", 1)),
    ON_THE_RUN(new AchievementBuilder("On the Run", 0, true)),
    ONCE_THE_HUNTER_NOW_THE_HUNTED(new AchievementBuilder("Once the hunter, now the hunted", 0, true).requirement("Helwyr uniques", 8)),
    ONE_DAY_YOU_SHALL_BE_A_FORK(new AchievementBuilder("One Day, You Shall Be a Fork", 0, true).requirement("Silver ore", 1)
        .requirement("Smithing", 20).reward("Smithing", 14).reward("Silver bar", 1)),
    ONE_FINAL_RIDE(new AchievementBuilder("One Final Ride", 0, true).requirement("Last riders", 1)),
    ONE_FOOT_IN_THE_GRAVE(new AchievementBuilder("One Foot in the Grave", 0, true).requirement("Returning Clarence", 1)),
    ONE_MANS_JUNK_IS_MINE(new AchievementBuilder("One Man's Junk...Is Mine", 0, true).requirement("Movario's base looting tasks", 5)),
    OOGLOG(new AchievementBuilder("Oo'glog", 0, true)),
    OPEN_BAR(new AchievementBuilder("Open Bar", 0, true).requirement("Asgarnian ale", 1).requirement("Asgarnian ale (m)", 1)
        ...
        .requirement("Mature cider", 1).requirement("Dragon bitter", 1).requirement("Dragon bitter (m)", 1).requirement("Dwarven stout", 1)
        .requirement("Dwarven stout (m)", 1).requirement("Greenman's ale", 1).requirement("Grog", 1).requirement("Moonlight mead", 1)
        .requirement("Moonlight mead (m)", 1).requirement("Pigswill", 1).requirement("Mature pigswill", 1).requirement("Ranger's aid", 1)
        .requirement("Ranger's aid (m)", 1).requirement("Slayer's respite", 1).requirement("Slayer's respite (m)", 1)
        .requirement("Squeck juice", 1).requirement("Wizard's mind bomb", 1).requirement("Mature wmb", 1)),
    ORDER_OF_SLAYERS(new AchievementBuilder("Order of Slayers", 8, true).requirement("While Guthix Sleeps", 1)
        .requirement("Smoking Kills", 1).requirement("Plague's End", 1).requirement("Barbarian Training", 1).requirement("Slayer", 85)
        .requirement("Combat", 120)),
    ORNATE_CROCKERY(new AchievementBuilder("Ornate Crockery", 0, true).requirement("Ornate bowl", 1)),
    OTTO_THE_ANCIENT(new AchievementBuilder("Otto the Ancient", 0, true).requirement("Ancient page", 26)),
    OUR_MAN_IN_THE_NORTH(new AchievementBuilder("Our Man in the North", 0, true).requirement("Our Man in the North", 1)),
    OUT_INTO_THE_OURANIA(new AchievementBuilder("Out into the Ourania", 0, true).requirement("Ourania Teleport", 1)),
    OUT_OF_BODY_EXPERIENCE(new AchievementBuilder("Out of Body Experience", 0, true).requirement("Corporeal Beast uniques", 7)),
    OYSTER_MASH(new AchievementBuilder("Oyster Mash", 0, true).requirement("Giant Oyster", 1)),
    PPPPICK_UP_SOME_PRIZES(new AchievementBuilder("P-P-P-Pick Up Some Prizes", 0, true).requirement("Penguin point", 1)),
    PAINT_IT_RED(new AchievementBuilder("Paint it Red", 0, true).requirement("Secrets of haemalchemy", 2)),
    PARTY_ANIMA(new AchievementBuilder("Party Anima", 0, true).requirement("Telos uniques", 8)),
    PARTY_POOPER(new AchievementBuilder("Party Pooper", 0, true).requirement("Monk's Friend", 1)),
    PEACHY_BONES(new AchievementBuilder("Peachy Bones", 0, true).requirement("Bones to Peaches", 1)),
    PENANCE_TO_THE_KING(new AchievementBuilder("Penance to the King", 0, true).requirement("Penance King", 1)),
    PENNY_FOR_YOUR_LIFE(new AchievementBuilder("Penny for your Life", 0, true).requirement("Dimension of Disaster post-quest rewards", 12)),
    PERKY_LIKE_A_PRAWN(new AchievementBuilder("Perky Like a Prawn", 0, true).requirement("Prawn perks", 15)),
    PICK_ALL(new AchievementBuilder("Pick All", 0, true).requirement("New Varrock chests", 49).reward("Zemomark", 60)),
    PICK_HALF(new AchievementBuilder("Pick Half", 0, true).requirement("New Varrock chests", 25).reward("Zemomark", 40)),
    PICK_ONE(new AchievementBuilder("Pick One", 0, true).requirement("New Varrock chests", 1).reward("Zemomark", 20)),
    PIOUS_PRAYERS(new AchievementBuilder("Pious Prayers", 0, true).requirement("Knight Waves training ground", 1)),
    PLANK_YOU_VERY_MUCH(new AchievementBuilder("Plank You Very Much", 0, true).requirement("Logs", 1).requirement("Coins", 100)
        .reward("Plank", 1)),
    PLAYING_THE_WAITING_GAME(new AchievementBuilder("Playing the Waiting Game", 0, true)),
    PORT_LIFE(new AchievementBuilder("Port Life", 0, true).requirement("Player-owned port tutorial", 1)),
    PORT_SARIM(new AchievementBuilder("Port Sarim", 0, true)),
    PORTENTIALLY_HAZARDOUS(new AchievementBuilder("Portentially Hazardous", 0, true).requirement("Pale energy", 30)
        .requirement("Sardine", 1).reward("Portent of restoration I", 1).reward("Divination", 1)),
    POST_FUME(new AchievementBuilder("Post Fume", 0, true).requirement("Desert Slayer Dungeon bosses", 4)),
    POTION_MIXER_MASTER(new AchievementBuilder("Potion Mixer Master", 0, true).requirement("Combination potion recipes", 26)),
    POTION_FOR_A_LADY(new AchievementBuilder("Potion for a Lady", 0, true).requirement("Super melee potion", 1)
        .lamp(Arrays.asList("Attack", "Strength"), 50000, 1)),
    POWER_OF_THREE_SPIRITS(new AchievementBuilder("Power of Three Spirits", 0, true).requirement("Plague's End", 1)
        .requirement("The Prisoner of Glouphrie", 1).requirement("Farming", 89)),
    PRAYER_GHOSTLY(new AchievementBuilder("Prayer - Ghostly", 0, true).requirement("Ghostly", 1)),
    PRAYER_5(new AchievementBuilder("Prayer 5", 0, true).requirement("Prayer", 5)),
    PRAYER_10(new AchievementBuilder("Prayer 10", 0, true).requirement("Prayer", 10)),
    PRAYER_20(new AchievementBuilder("Prayer 20", 0, true).requirement("Prayer", 20)),
    PRAYER_30(new AchievementBuilder("Prayer 30", 0, true).requirement("Prayer", 30)),
    PRAYER_40(new AchievementBuilder("Prayer 40", 0, true).requirement("Prayer", 40)),
    PRAYER_50(new AchievementBuilder("Prayer 50", 0, true).requirement("Prayer", 50)),
    PRAYER_60(new AchievementBuilder("Prayer 60", 0, true).requirement("Prayer", 60)),
    PRAYER_70(new AchievementBuilder("Prayer 70", 0, true).requirement("Prayer", 70)),
    PRAYER_80(new AchievementBuilder("Prayer 80", 0, true).requirement("Prayer", 80)),
    PRAYER_90(new AchievementBuilder("Prayer 90", 0, true).requirement("Prayer", 90)),
    PRAYER_92(new AchievementBuilder("Prayer 92", 0, true).requirement("Prayer", 92)),
    PRAYER_99(new AchievementBuilder("Prayer 99", 0, true).requirement("Prayer", 99)),
    PREACHING_TO_THE_INFECTED(new AchievementBuilder("Preaching to the Infected", 0, true).requirement("Plague City", 1)),
    PRIFDDINAS(new AchievementBuilder("Prifddinas", 0, true).requirement("Plague's End", 1)),
    PRIME_HATCHLING(new AchievementBuilder("Prime Hatchling", 0, true).requirement("Dagannoth egg", 1)),
    PRISON_BREAK(new AchievementBuilder("Prison Break", 0, true)
        .encounter(new Encounter(Arrays.asList(Arrays.asList(Enemy.AIRUT, Enemy.AIRUT, Enemy.CHARGER, Enemy.CHARGER),
            Arrays.asList(Enemy.AIRUT, Enemy.AIRUT, Enemy.CHARGER, Enemy.CHARGER),
            Arrays.asList(Enemy.AIRUT, Enemy.CHARGER, Enemy.CHARGER, Enemy.CHARGER),
            Arrays.asList(Enemy.AIRUT, Enemy.AIRUT, Enemy.AIRUT, Enemy.CHARGER, Enemy.CHARGER),
            ...
            Arrays.asList(Enemy.AIRUT, Enemy.AIRUT, Enemy.AIRUT, Enemy.AIRUT, Enemy.AIRUT, Enemy.AIRUT, Enemy.AIRUT),
            Arrays.asList(Enemy.TUZ, Enemy.KRAR, Enemy.BEASTMASTER_DURZAG))))),
    PRISON_BREAK_FEAT(new AchievementBuilder("Prison Break (feat)", 0, true).requirement("Nex uniques", 21)),
    QUEEN_BLACK_DRAGONLING(new AchievementBuilder("Queen Black Dragonling", 0, true).requirement("Queen black dragon scale", 1)
        .requirement("Summoning", 99)),
    QUIET_BUT_DEADLY_LORE(new AchievementBuilder("Quiet but Deadly Lore", 0, true).requirement("Dragonkin journals", 4)),
    RANGED_SPARKY(new AchievementBuilder("Ranged - Sparky", 0, true).requirement("Sparky", 1)),
    RANGED_5(new AchievementBuilder("Ranged 5", 0, true).requirement("Ranged", 5)),
    RANGED_10(new AchievementBuilder("Ranged 10", 0, true).requirement("Ranged", 10)),
    RANGED_20(new AchievementBuilder("Ranged 20", 0, true).requirement("Ranged", 20)),
    RANGED_30(new AchievementBuilder("Ranged 30", 0, true).requirement("Ranged", 30)),
    RANGED_40(new AchievementBuilder("Ranged 40", 0, true).requirement("Ranged", 40)),
    RANGED_50(new AchievementBuilder("Ranged 50", 0, true).requirement("Ranged", 50)),
    RANGED_60(new AchievementBuilder("Ranged 60", 0, true).requirement("Ranged", 60)),
    RANGED_70(new AchievementBuilder("Ranged 70", 0, true).requirement("Ranged", 70)),
    RANGED_80(new AchievementBuilder("Ranged 80", 0, true).requirement("Ranged", 80)),
    RANGED_90(new AchievementBuilder("Ranged 90", 0, true).requirement("Ranged", 90)),
    RANGED_92(new AchievementBuilder("Ranged 92", 0, true).requirement("Ranged", 92)),
    RANGED_99(new AchievementBuilder("Ranged 99", 0, true).requirement("Ranged", 99)),
    RANK_MASTER_FINIX(new AchievementBuilder("Rank: Master Finix", 0, true).requirement("Esteem rank", 10)),
    RAWRVEK(new AchievementBuilder("Rawrvek", 0, true).requirement("Glimmering scale", 1)),
    READY_DEADY_COOK(new AchievementBuilder("Ready, Deady, Cook", 0, true).requirement("Dimension of Disaster: Coin of the Realm", 1)
        .requirement("New Varrock raw undead meat", 1).reward("Zemomark", 20)),
    REAPER_CREW(new AchievementBuilder("Reaper Crew", 0, true).requirement("Bosses defeated", 29)),
    RED_REVOLUTION(new AchievementBuilder("Red Revolution", 0, true).requirement("Plague City", 1)),
    REEVES(new AchievementBuilder("Reeves", 0, true).requirement("Blood tentacle", 1)),
    RELIGHT_MY_FIRE(new AchievementBuilder("Relight My Fire", 0, true).requirement("Dragon Forge tasks", 4)),
    RELIQUARY_OF_CITHARA(new AchievementBuilder("Reliquary of Cithara", 0, true).requirement("Holy Cithara", 1).reward("Prayer", 50000)),
    RESPECT_THE_BALANCE(new AchievementBuilder("Respect the Balance", 0, true).requirement("Respects paid", 6)),
    REVENGE_IS_SWEET(new AchievementBuilder("Revenge is Sweet", 0, true).requirement("Vindicta uniques", 8)),
    REWIND(new AchievementBuilder("Rewind", 0, true).requirement("Beastmaster Durzag", 1)
        .encounter(new Encounter(Arrays.asList(Collections.singletonList(Enemy.YAKAMARU),
            Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU), Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU),
            Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU), Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU),
            Collections.singletonList(Enemy.YAKAMARU), Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU),
            Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU), Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU),
            Collections.singletonList(Enemy.IMAGE_OF_YAKAMARU))))),
    REX_HATCHLING(new AchievementBuilder("Rex Hatchling", 0, true).requirement("Shrivelled dragon claw", 1)),
    RHIAN_IN_GOLD_THE_ORIGINAL(new AchievementBuilder("Rhian In Gold - The Original", 0, true).requirement("Statue of Rhiannon", 1)),
    ROBOT_OF_SHERWOOD(new AchievementBuilder("Robot of Sherwood", 0, true).requirement("Plague's End", 1).requirement("Thieving", 95)
        .reward("Thieving", 145).reward("Coins", 135)),
    ROGUE_DOWN(new AchievementBuilder("Rogue Down", 0, true).requirement("Wilderness portal rogue trader freed", 1)),
    RUNECRAFTING_RUE(new AchievementBuilder("Runecrafting - Rue", 0, true).requirement("Rue", 1)),
    RUNECRAFTING_5(new AchievementBuilder("Runecrafting 5", 0, true).requirement("Runecrafting", 5)),
    RUNECRAFTING_10(new AchievementBuilder("Runecrafting 10", 0, true).requirement("Runecrafting", 10)),
    RUNECRAFTING_20(new AchievementBuilder("Runecrafting 20", 0, true).requirement("Runecrafting", 20)),
    RUNECRAFTING_30(new AchievementBuilder("Runecrafting 30", 0, true).requirement("Runecrafting", 30)),
    RUNECRAFTING_40(new AchievementBuilder("Runecrafting 40", 0, true).requirement("Runecrafting", 40)),
    RUNECRAFTING_50(new AchievementBuilder("Runecrafting 50", 0, true).requirement("Runecrafting", 50)),
    RUNECRAFTING_60(new AchievementBuilder("Runecrafting 60", 0, true).requirement("Runecrafting", 60)),
    RUNECRAFTING_70(new AchievementBuilder("Runecrafting 70", 0, true).requirement("Runecrafting", 70)),
    RUNECRAFTING_80(new AchievementBuilder("Runecrafting 80", 0, true).requirement("Runecrafting", 80)),
    RUNECRAFTING_90(new AchievementBuilder("Runecrafting 90", 0, true).requirement("Runecrafting", 90)),
    RUNECRAFTING_92(new AchievementBuilder("Runecrafting 92", 0, true).requirement("Runecrafting", 92)),
    RUNECRAFTING_99(new AchievementBuilder("Runecrafting 99", 0, true).requirement("Runecrafting", 99)),
    RUSTY_REWARD(new AchievementBuilder("Rusty Reward", 0, true).requirement("Rocking Out", 1).reward("Coins", 20)),
    SAFETY_DANCE(new AchievementBuilder("Safety Dance", 0, true).requirement("Summoning", 60)
        .encounter(new Encounter(Enemy.QUEEN_BLACK_DRAGON))),
    SCABIGAIL(new AchievementBuilder("Scabigail", 0, true).requirement("Scabaras page", 19)),
    SCRIBBLING_IN_THE_DEPTHS(new AchievementBuilder("Scribbling in the Depths", 0, true).requirement("Song from the Depths", 1)
        .requirement("Constitution", 80)),
    SCRIBBLINGS_OF_A_DRAGONKIN(new AchievementBuilder("Scribblings of a Dragonkin", 0, true).requirement("Vicendithas' Scribblings", 1)),
    SCROLLING_WITH_POWER(new AchievementBuilder("Scrolling with Power", 0, true).requirement("Dungeoneering scrolls", 8)),
    SCRYING_GAME(new AchievementBuilder("Scrying Game", 0, true).requirement("Dimension of Disaster: Defender of Varrock", 1)
        .requirement("Zemomark", 60)),
    SEAGULLIBLE(new AchievementBuilder("Seagullible", 0, true).requirement("Ports reputation", 300000)),
    SECOND_SHRUBBERY(new AchievementBuilder("Second Shrubbery", 0, true).requirement("Herring", 1)),
    SEEING_LAVA(new AchievementBuilder("Seeing Lava", 0, true).requirement("Fire cape", 1)
        .encounter(new Encounter(Arrays.asList(Collections.singletonList(Enemy.TZ_KIH), Arrays.asList(Enemy.TZ_KIH, Enemy.TZ_KIH),
            Collections.singletonList(Enemy.TZ_KEK), Arrays.asList(Enemy.TZ_KEK, Enemy.TZ_KEK), Arrays.asList(Enemy.TZ_KEK, Enemy.TZ_KIH),
            ...
            Arrays.asList(Enemy.TOK_XIL, Enemy.TZ_KEK, Enemy.TZ_KEK), Arrays.asList(Enemy.TZ_KEK, Enemy.TZ_KEK, Enemy.TZ_KEK, Enemy.TZ_KEK),
            ...
            Arrays.asList(Enemy.YT_MEJKOT, Enemy.TOK_XIL, Enemy.TZ_KEK, Enemy.TZ_KIH, Enemy.TZ_KIH), Arrays.asList(Enemy.TZ_KEK, Enemy.TZ_KEK),
            ...
            Arrays.asList(Enemy.KET_ZEK, Enemy.YT_MEJKOT, Enemy.TZ_KEK, Enemy.TZ_KIH, Enemy.TZ_KIH), Arrays.asList(Enemy.TZ_KEK, Enemy.TZ_KEK),
            Arrays.asList(Enemy.KET_ZEK, Enemy.YT_MEJKOT, Enemy.TZ_KEK, Enemy.TZ_KEK), Arrays.asList(Enemy.TZ_KEK, Enemy.TZ_KEK, Enemy.TZ_KEK, Enemy.TZ_KEK),
