...
public enum Enemy {
	...
	AHRIM_THE_BLIGHTED_ROTS("Ahrim the Blighted (ROTS)", 12500, 1787.4, 589.8, 0, 0, 864, 0, 0, 90, 2, 0, 0, 2458, 1924, 90, "Nothing", 0, 40, 40, 40),
	DHAROK_THE_WRETCHED_ROTS("Dharok the Wretched (ROTS)", 12500, 1787.4, 589.8, 1296, 0, 0, 90, 0, 0, 5, 2458, 0, 0, 1924, 90, "Nothing", 0, 40, 40, 40),
	GUTHAN_THE_INFESTED_ROTS("Guthan the Infested (ROTS)", 12500, 1787.4, 589.8, 1296, 0, 0, 90, 0, 0, 5, 2458, 0, 0, 1924, 90, "Nothing", 0, 40, 40, 40),
	KARIL_THE_TAINTED_ROTS("Karil the Tainted (ROTS)", 12500, 1787.4, 589.8, 0, 864, 0, 0, 90, 0, 2, 0, 2458, 0, 1924, 90, "Nothing", 0, 40, 40, 40),
	TORAG_THE_CORRUPTED_ROTS("Torag the Corrupted (ROTS)", 12500, 1787.4, 589.8, 1296, 0, 0, 90, 0, 0, 5, 2458, 0, 0, 1924, 90, "Nothing", 0, 40, 40, 40),
	VERAC_THE_DEFILED_ROTS("Verac the Defiled (ROTS)", 12500, 1787.4, 589.8, 1296, 0, 0, 90, 0, 0, 5, 2458, 0, 0, 1924, 90, "Nothing", 0, 40, 40, 40),
	...
	IMAGE_OF_YAKAMARU("Image of Yakamaru", 15000, 2893.69, 954.91, 0, 0, 1788, 0, 0, 99, 4, 0, 0, 2458, 2765, 99, "Nothing", 0, 55, 55, 55),
	...
	AIRUT("Airut", 16875, 2052, 677.1, 0, 816, 0, 0, 85, 0, 4, 0, 3031, 0, 2458, 90, "Nothing", 0, 65, 55, 45),
	...
	KRAR("Krar", 70000, 50, 16.5, 2123, 2123, 0, 85, 85, 0, 5, 2178, 2178, 0, 1924, 80, "Water", 90, 55, 45, 65),
	TUZ("Tuz", 70000, 50, 16.5, 2123, 0, 2123, 85, 0, 85, 4, 2178, 2178, 2178, 2178, 80, "Bolts", 90, 45, 65, 55),
	KREEARRA("Kree'arra", 75000, 6573, 2169, 1676, 1080, 1080, 75, 75, 75, 3, 1694, 1694, 1694, 1299, 75, "Nothing", 0, 10, 70, 70),
	KALPHITE_KING("Kalphite King", 130000, 13231.1, 4366.25, 2560, 2560, 2560, 90, 90, 90, 5, 2343, 2343, 2343, 2178, 85, "Nothing", 0, 30, 30, 30),
	BEASTMASTER_DURZAG("Beastmaster Durzag", 150000, 100, 33, 1788, 1788, 0, 85, 85, 0, 6, 2458, 2458, 0, 2458, 95, "Nothing", 0, 55, 55, 55),
	...
	YAKAMARU("Yakamaru", 500000, 500, 165, 0, 1653, 1653, 0, 99, 99, 4, 0, 2458, 2458, 2765, 99, "Nothing", 0, 55, 55, 55);
