...
public enum Enemy {
    ...
    CHOMPY_BIRD("Chompy bird", 300, 62.2, 20.5, 6, 8, 0, 1, 2, 0, 4, 15, 120, 0, 110, 1, "Arrows", 90, 55, 45, 65),
    MONKEY("Monkey", 300, 27.6, 9.1, 24, 0, 0, 6, 0, 0, 4, 160, 0, 0, 160, 6, "Earth", 90, 55, 45, 65),
    ...
    MONK_OF_ZAMORAK("Monk of Zamorak", 850, 39.6, 13, 0, 0, 68, 0, 0, 17, 4, 0, 0, 280, 280, 17, "Arrows", 90, 55, 45, 65),
    MOSS_GIANT_GLARIAL("Moss Giant (Glarial's Tomb)", 1000, 62.8, 20.7, 132, 0, 176, 33, 0, 44, 4, 502, 0, 710, 710, 44, "Arrows", 90, 45, 65, 55),
    ...
    MOURNER_ARDY("Mourner (Ardougne)", 1200, 51.9, 17.1, 96, 0, 0, 24, 0, 0, 4, 368, 0, 0, 268, 24, "Fire", 90, 55, 45, 65),
    CERBERUS("Cerberus", 1200, 51.9, 17.1, 96, 0, 0, 24, 0, 0, 4, 368, 0, 0, 368, 24, "Fire", 90, 55, 45, 65),
    ...
    TYRAS_GUARD("Tyras guard", 2100, 114.6, 27.8, 168, 0, 0, 42, 0, 0, 4, 668, 0, 0, 668, 42, "Earth", 90, 55, 45, 65),
    VAMPYRE_JUVINATE_IAOTM_A("Vampyre Juvinate (In Aid of the Myreque A)", 2100, 0, 0, 0, 168, 0, 0, 42, 0, 4, 0, 668, 0, 668, 42, "Stab", 90, 65, 55, 45),
    BROODOO_VICTIM("Broodoo victim", 2150, 119.7, 39.5, 172, 0, 0, 43, 0, 0, 4, 689, 0, 0, 689, 43, "Fire", 90, 55, 45, 65),
    VAMPYRE_JUVINATE_IAOTM_B("Vampyre Juvinate (In Aid of the Myreque B)", 2250, 0, 0, 0, 180, 0, 0, 45, 0, 4, 0, 732, 0, 732, 45, "Stab", 90, 65, 55, 45),
    ...
    VAMPYRE_JUVINATE_IAOTM_C("Vampyre Juvinate (In Aid of the Myreque C", 2450, 0, 0, 0, 196, 0, 0, 49, 0, 4, 0, 825, 0, 825, 49, "Stab", 90, 65, 55, 45),
    ...
    VYREWATCH("Vyrewatch", 2500, 166.8, 55, 0, 0, 200, 0, 0, 50, 4, 0, 0, 850, 850, 50, "Bolts", 90, 45, 65, 55),
    ...
    FISTANDANTILUS("Fistandantilus", 2750, 211.5, 69.7, 0, 0, 220, 0, 0, 55, 4, 0, 0, 983, 983, 55, "Arrows", 90, 45, 65, 55),
    ZAROMARK_SLIVER("Zaromark Sliver", 2750, 211.5, 69.7, 220, 220, 0, 55, 55, 0, 4, 983, 983, 0, 983, 55, "Nothing", 0, 55, 45, 45),
    DAGANNOTH("Dagannoth", 2800, 221.7, 73.1, 224, 0, 0, 56, 0, 0, 4, 1011, 0, 0, 1011, 56, "Earth", 90, 55, 45, 65),
    DEMON_UP("Demon (Underground Pass)", 2800, 221.7, 73.1, 224, 0, 0, 56, 0, 0, 4, 1011, 0, 0, 1011, 56, "Air", 90, 55, 45, 65),
    MOURNER("Mourner", 2850, 233.1, 76.9, 228, 0, 0, 57, 0, 0, 4, 1040, 0, 0, 1040, 57, "Fire", 90, 55, 45, 65),
    KALRAG("Kalrag", 2900, 244.8, 80.7, 232, 0, 0, 58, 0, 0, 4, 1070, 0, 0, 1070, 58, "Water", 90, 55, 45, 65),
    PALADIN_UP("Paladin (Underground Pass)", 2900, 244.8, 80.7, 550, 0, 0, 58, 0, 0, 4, 1070, 0, 0, 1070, 58, "Earth", 90, 55, 45, 65),
    ...
    SKELETON_HELLHOUND("Skeleton Hellhound", 8000, 217.8, 71.8, 307, 0, 0, 32, 0, 0, 4, 486, 0, 0, 486, 32, "Air", 90, 55, 45, 65),
    ...
    GADDERANKS("Gadderanks", 10500, 343.8, 113.4, 403, 0, 0, 42, 0, 0, 4, 668, 0, 0, 668, 42, "Fire", 90, 55, 45, 65),
