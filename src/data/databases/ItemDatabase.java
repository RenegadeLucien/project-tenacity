...
public class ItemDatabase {
    ...
    private void addItems() {
        ...
        items.add(new Item("Ale yeast", 1));
        ...
        items.add(new Item("Axeman's folly", 2));
        items.add(new Item("Axeman's folly (m)", 2));
        ...
        items.add(new Item("Beer (tankard)", 26));
        items.add(new Item("Bird snare", 6));
        items.add(new Item("Bittercap mushroom", 38));
        items.add(new Item("Bittercap mushroom spore", 86));
        items.add(new Item("Black 2h sword", 1920));
        items.add(new Item("Black dragonhide body", 13480));
        items.add(new Item("Black dragonhide boots", 4320));
        items.add(new Item("Black dragonhide chaps", 6220));
        items.add(new Item("Black dragonhide coif", 6220));
        items.add(new Item("Black dragonhide shield", 17973));
        items.add(new Item("Black dragonhide vambraces", 4320));
        items.add(new Item("Black full helm", 1372));
        items.add(new Item("Black platebody", 3840));
        items.add(new Item("Black platelegs", 1920));
        ...
        items.add(new Item("Blood nihil pouch", 5699));
        ...
        items.add(new Item("Blurberry Special", 30));
        items.add(new Item("Bolt of cloth", 650));
        items.add(new Item("Bone bolts", 4));
        ...
        items.add(new Item("Bracelet of clay", 1265));
        ...
        items.add(new Item("Bronze full helm", 44));
        ...
        items.add(new Item("Chef's hat", 2));
        items.add(new Item("Chisel", 14));
        items.add(new Item("Chocolate Saturday", 30));
        ...
        items.add(new Item("Davy kebbit hat", 100));
        ...
        items.add(new Item("Dragon bitter (m)", 2));
        items.add(new Item("Dragon bones", 1));
        items.add(new Item("Dragonfire shield", 2000000));
        items.add(new Item("Dreadfowl pouch", 624));
        items.add(new Item("Drunk Dragon", 30));
        items.add(new Item("Dwarven stout", 2));
        items.add(new Item("Dwarven stout (m)", 2));
        ...
        items.add(new Item("Evil turnip pouch", 3024));
        ...
        items.add(new Item("Fetch casket scroll", 300));
        ...
        items.add(new Item("Flickering energy", 7));
        ...
        items.add(new Item("Gold ore", 150));
        ...
        items.add(new Item("Granite lobster pouch", 4574));
        ...
        items.add(new Item("Jute fibre", 6));
        ...
        items.add(new Item("Marble block", 325000));
        items.add(new Item("Marigold seed", 84));
        items.add(new Item("Mature cider", 2));
        items.add(new Item("Mature pigswill", 50));
        items.add(new Item("Mature wmb", 2));
        items.add(new Item("Meat pizza", 50));
        items.add(new Item("Meerkats pouch", 3000));
        ...
        items.add(new Item("Pigswill", 32));
        ...
        items.add(new Item("Pot (unfired)", 1));
        ...
        items.add(new Item("Ranger's aid (m)", 50));
        ...
        items.add(new Item("Raw pawya meat", 500));
        items.add(new Item("Raw potato", 16));
        items.add(new Item("Raw rat meat", 39));
        items.add(new Item("Raw rocktail", 600));
        ...
        items.add(new Item("Red boater", 225));
        ...
        items.add(new Item("Relicym's balm (4)", 225));
        ...
        items.add(new Item("Rune pickaxe", 32000));
        ...
        items.add(new Item("Shadow nihil pouch", 5699));
        ...
        items.add(new Item("Slayer's respite (m)", 2));
        items.add(new Item("Slimy eel", 1));
        items.add(new Item("Small fishing net", 40));
        items.add(new Item("Smoke nihil pouch", 5699));
        ...
        items.add(new Item("Spirit spider pouch", 624));
        items.add(new Item("Spirit wolf pouch", 599));
        items.add(new Item("Squeck juice", 2));
        ...
        items.add(new Item("War tortoise pouch", 449));
