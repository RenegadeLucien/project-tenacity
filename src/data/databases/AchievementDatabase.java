...
public class AchievementDatabase {
    ...
    private void addAchievementsABC() {
        achievements.add(new AchievementBuilder("1001 Kharidian Spikes", 0.05, true).requirement("Cactus seed", 1).reward("Farming", 465)
        ...
        achievements.add(new AchievementBuilder("A Brief History of Telescopes", 0.05, true).requirement("Player-owned-port telescope", 1)
        ...
        achievements.add(new AchievementBuilder("Gertrude's Cat", 0.75, false).requirement("Raw sardine", 1).requirement("Coins", 100)
        ...
        achievements.add(new AchievementBuilder("Underground Pass", 2, false).requirement("Biohazard", 1).requirement("Ranged", 25)
        ...
        achievements.add(new AchievementBuilder("Regicide", 1.5, false).requirement("Agility", 56).requirement("Crafting", 10)
        ...
        achievements.add(new AchievementBuilder("Catapult Construction", 0.5, false).requirement("Regicide", 1).requirement("Fletching", 42)
        ...
        achievements.add(new AchievementBuilder("Big Chompy Bird Hunting", 0.75, false).requirement("Cooking", 30)
        ...
        achievements.add(new AchievementBuilder("Sheep Herder", 0.75, false).requirement("Coins", 100).reward("Coins", 3100)
            .reward("Quest points", 4).build());
        achievements.add(new AchievementBuilder("Waterfall Quest", 0.75, false).requirement("Air rune", 6).requirement("Earth rune", 6)
        ...
        achievements.add(new AchievementBuilder("Roving Elves", 1, false).requirement("Waterfall Quest", 1).requirement("Regicide", 1)
        ...
        achievements.add(new AchievementBuilder("Mourning's End Part I", 2, false).requirement("Big Chompy Bird Hunting", 1)
        ...
        achievements.add(new AchievementBuilder("Mourning's End Part II", 2.5, false).requirement("Mourning's End Part I", 1)
            .requirement("Rope", 1).requirement("Death talisman", 0).reward("Quest points", 2).reward("Agility", 20000).build());
        achievements.add(new AchievementBuilder("Within the Light", 1.5, false).requirement("Mourning's End Part II", 1)
        ...
        achievements.add(new AchievementBuilder("Bringing Home the Bacon", 1, false).requirement("Farming", 14).requirement("Summoning", 14)
        ...
        achievements.add(new AchievementBuilder("Cook's Assistant", 0.25, false).reward("Quest points", 1).reward("Cooking", 300)
        ...
        achievements.add(new AchievementBuilder("The Fremennik Trials", 1.5, false).requirement("Crafting", 40).requirement("Fletching", 25)
        ...
        achievements.add(new AchievementBuilder("Throne of Miscellania", 0.75, false).requirement("Heroes' Quest", 1)
        ...
        achievements.add(new AchievementBuilder("Royal Trouble", 1, false).requirement("Throne of Miscellania", 1)
        ...
        achievements.add(new AchievementBuilder("Lost City", 0.75, false).requirement("Crafting", 31).requirement("Woodcutting", 36)
            .encounter(new Encounter("Dramen tree spirit", Collections.singletonList(new Restriction("Gear", 0)))).reward("Quest points", 3)
            .build());
        achievements.add(new AchievementBuilder("Rune Mysteries", 1, false).reward("Quest points", 1).reward("Magic", 250)
            .reward("Runecrafting", 250).reward("Air talisman", 1).reward("First tower hat", 1).reward("Tower mindspike", 1)
            .reward("Mind rune", 70).build());
        achievements.add(new AchievementBuilder("Jungle Potion", 0.25, false).requirement("Herblore", 3).reward("Quest points", 1)
            .reward("Herblore", 775).build());
        achievements.add(new AchievementBuilder("Shilo Village", 1, false).requirement("Jungle Potion", 1).requirement("Crafting", 20)
        ...
        achievements.add(new AchievementBuilder("Lunar Diplomacy", 1.5, false).requirement("Lost City", 1).requirement("Rune Mysteries", 1)
        ...
        achievements.add(new AchievementBuilder("A Taste of the Exotic", 0.05, true).requirement("Papaya tree seed", 1)
        ...
        achievements.add(new AchievementBuilder("Fairy Tale I - Growing Pains", 0.75, false).requirement("Lost City", 1)
        ...
        achievements.add(new AchievementBuilder("Fairy Tale II - Cure a Queen", 0.75, false).requirement("Fairy Tale I - Growing Pains", 1)
        ...
        achievements.add(new AchievementBuilder("A Visit to Charlie", 0, true).requirement("Fairy Tale II - Cure a Queen", 1).build());
        ...
        achievements.add(new AchievementBuilder("Ace of Dungeons", 0, true).requirement("Plague's End", 1).requirement("Gorajo card", 1)
            .build());
        achievements.add(new AchievementBuilder("Ad-Myre The Goods", 0, true).requirement("Shades of Mort'ton", 1).build());
        achievements.add(new AchievementBuilder("Stolen Hearts", 1, false)
        ...
        achievements.add(new AchievementBuilder("Diamond in the Rough", 1, false).requirement("Stolen Hearts", 1)
            ...
            .build());
        achievements.add(new AchievementBuilder("Swept Away", 0.5, false).reward("Quest points", 2).lamp(Player.ALL_SKILLS, -10, 1)
        ...
        achievements.add(new AchievementBuilder("Broomstick enchantment 1", 0, false).requirement("Swept Away", 1)
            .requirement("Diamond in the Rough", 1).build());
        achievements.add(new AchievementBuilder("Broomstick enchantment 2", 0, false).requirement("Broomstick enchantment 1", 1)
            .requirement("Magic", 33).reward("Magic", 1997).build());
        achievements.add(new AchievementBuilder("Broomstick enchantment 3", 0, false).requirement("Broomstick enchantment 2", 1)
            .requirement("Magic", 53).reward("Magic", 7139).build());
        achievements.add(new AchievementBuilder("Broomstick enchantment 4", 0, false).requirement("Broomstick enchantment 3", 1)
            .requirement("Lunar Diplomacy", 1).requirement("Magic", 73).reward("Magic", 10338).build());
        achievements.add(new AchievementBuilder("Broomstick enchantment 5", 0, false).requirement("Broomstick enchantment 4", 1)
            .requirement("Magic", 93).requirement("Underground Pass", 1).reward("Magic", 14979).build());
        achievements.add(new AchievementBuilder("Advanced Sweeping", 0, true).requirement("Broomstick enchantment 5", 1).build());
        ...
        achievements.add(new AchievementBuilder("Agile from Head to Toe", 0, true).requirement("Advanced Barbarian Outpost laps", 250)
        ...
        achievements.add(new AchievementBuilder("The Frog Prince v. The People", 0.25, false).requirement("Court summons 5", 1)
        ...
        achievements.add(new AchievementBuilder("Miss Schism v. Draynor Village", 0.75, false).requirement("Court summons 9", 1)
        ...
        achievements.add(new AchievementBuilder("Murder Mystery", 0.75, false).requirement("Empty pot", 1).reward("Quest points", 3)
            .reward("Coins", 2000).reward("Pot of flour", 1).reward("Crafting", 1406).build());
        achievements.add(new AchievementBuilder("Merlin's Crystal", 0.75, false).requirement("Bread", 1).requirement("Bucket", 1)
            .requirement("Bat bones", 1).encounter(new Encounter("Sir Mordred")).reward("Quest points", 6).build());
        achievements.add(new AchievementBuilder("Holy Grail", 0.5, false).requirement("Merlin's Crystal", 1).requirement("Attack", 30)
            .encounter(new Encounter("Black Knight Titan")).reward("Quest points", 2).reward("Defense", 15300).reward("Prayer", 11000)
            .build());
        achievements.add(new AchievementBuilder("One Small Favour", 1.5, false).requirement("Rune Mysteries", 1)
        ...
        achievements.add(new AchievementBuilder("King's Ransom", 1, false).requirement("Holy Grail", 1).requirement("Murder Mystery", 1)
        ...
        achievements.add(new AchievementBuilder("Mugger v. Roger Murray", 0.25, false).requirement("King's Ransom", 1)
            .lamp(Arrays.asList("Attack", "Defense", "Strength", "Magic", "Ranged", "Constitution", "Slayer", "Prayer", "Summoning",
                "Herblore"), 2000, 1).build());
        achievements.add(new AchievementBuilder("All Rise", 0, true).requirement("Mugger v. Roger Murray", 1)
        ...
        achievements.add(new AchievementBuilder("Dragon Slayer", 1.5, false).requirement("Quest points", 33).requirement("Silk", 1)
        ...
        achievements.add(new AchievementBuilder("Animal Cruelty", 0, true).encounter(new Encounter(Arrays.asList(Arrays.asList("Airut",
        ...
        achievements.add(new AchievementBuilder("Ankle Support", 0, true).requirement("Do No Evil", 1).build());
        ...
        achievements.add(new AchievementBuilder("The Grand Tree", 1.5, false).encounter(new Encounter("Black demon (The Grand Tree)"))
            .reward("Quest points", 5).reward("Agility", 7900).reward("Attack", 18400).reward("Magic", 2150).build());
        achievements.add(new AchievementBuilder("Tree Gnome Village", 0.75, false).requirement("Logs", 6)
            .encounter(new Encounter("Khazard warlord")).reward("Quest points", 2).reward("Attack", 11450).build());
        achievements.add(new AchievementBuilder("Monkey Madness", 2.5, false).requirement("The Grand Tree", 1)
        ...
        achievements.add(new AchievementBuilder("Impressing the Locals", 0.25, true).requirement("Coins", 1000).reward("Quest points", 1)
            .build());
        achievements.add(new AchievementBuilder("Arc - All Your Energies", 0, true).requirement("Chimes", 5000).requirement("Taijitu", 5)
        ...
        achievements.add(new AchievementBuilder("Whale's Maw Camp Fire", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 500).build());
        achievements.add(new AchievementBuilder("Whale's Maw Deposit Box", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 750).build());
        achievements.add(new AchievementBuilder("Arc journal teletabs", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 1000).build());
        achievements.add(new AchievementBuilder("Crystal tool siphon blueprint", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 5000).requirement("Taijitu", 5).build());
        achievements.add(new AchievementBuilder("Waiko Grill", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 500).build());
        ...
        achievements.add(new AchievementBuilder("Supplies cost reduction 1", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 3000).requirement("Taijitu", 3).build());
        achievements.add(new AchievementBuilder("Supplies cost reduction 2", 0, false).requirement("Chimes", 3000).requirement("Taijitu", 3)
            .requirement("Supplies cost reduction 1", 1).build());
        achievements.add(new AchievementBuilder("Supplies cost reduction 3", 0, false).requirement("Chimes", 3000).requirement("Taijitu", 3)
            .requirement("Supplies cost reduction 2", 1).build());
        achievements.add(new AchievementBuilder("Supplies cost reduction 4", 0, false).requirement("Chimes", 3000).requirement("Taijitu", 3)
            .requirement("Supplies cost reduction 3", 1).build());
        achievements.add(new AchievementBuilder("Supplies cost reduction 5", 0, false).requirement("Chimes", 3000).requirement("Taijitu", 3)
            .requirement("Supplies cost reduction 4", 1).build());
        achievements.add(new AchievementBuilder("Supplies cap increase 1", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 2000).requirement("Taijitu", 2).build());
        achievements.add(new AchievementBuilder("Supplies cap increase 2", 0, false).requirement("Chimes", 2000).requirement("Taijitu", 2)
            .requirement("Supplies cap increase 1", 1).build());
        achievements.add(new AchievementBuilder("Supplies cap increase 3", 0, false).requirement("Chimes", 2000).requirement("Taijitu", 2)
            .requirement("Supplies cap increase 2", 1).build());
        achievements.add(new AchievementBuilder("Supplies cap increase 4", 0, false).requirement("Chimes", 2000).requirement("Taijitu", 2)
            .requirement("Supplies cap increase 3", 1).build());
        achievements.add(new AchievementBuilder("Contracts per day increase 1", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 2500).requirement("Taijitu", 2).build());
        achievements.add(new AchievementBuilder("Contracts per day increase 2", 0, false).requirement("Chimes", 2500)
            .requirement("Taijitu", 2).requirement("Contracts per day increase 1", 1).build());
        achievements.add(new AchievementBuilder("Contracts per day increase 3", 0, false).requirement("Chimes", 2500)
            .requirement("Taijitu", 2).requirement("Contracts per day increase 2", 1).build());
        achievements.add(new AchievementBuilder("Contracts per day increase 4", 0, false).requirement("Chimes", 2500)
            .requirement("Taijitu", 2).requirement("Contracts per day increase 3", 1).build());
        achievements.add(new AchievementBuilder("Commodity sell per day increase 1", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 1500).requirement("Taijitu", 1).build());
        achievements.add(new AchievementBuilder("Commodity sell per day increase 2", 0, false).requirement("Chimes", 1500)
            .requirement("Taijitu", 1).requirement("Commodity sell per day increase 1", 1).build());
        achievements.add(new AchievementBuilder("Commodity sell price increase 1", 0, false).requirement("Impressing the Locals", 1)
            .requirement("Chimes", 8000).requirement("Taijitu", 8).build());
        achievements.add(new AchievementBuilder("Commodity sell price increase 2", 0, false).requirement("Chimes", 8000)
        ...
        achievements.add(new AchievementBuilder("Arc - Upgrading Waiko", 0, true).requirement("Commodity sell per day increase 1", 1)
        ...
        achievements.add(new AchievementBuilder("Arc IV - Jed Hunter", 0.25, true).requirement("Arc I - Flag Fall", 1)
        ...
        achievements.add(new AchievementBuilder("Arc V - Eye for an Eye", 0.25, true).requirement("Arc IV - Jed Hunter", 1)
        ...
        achievements.add(new AchievementBuilder("Arc VIII - Ghosts from the Past", 0.25, true).requirement("Arc VI - Harbinger of Doom", 1)
        ...
        achievements.add(new AchievementBuilder("Tower of Life", 1, false).requirement("Construction", 10).requirement("Coins", 2)
        ...
        achievements.add(new AchievementBuilder("Monk's Friend", 0.25, false).requirement("Jug of water", 1).requirement("Logs", 1)
        ...
        achievements.add(new AchievementBuilder("No Time to Lose", 0, true).requirement("Ring of duelling (8)", 1).build());
        achievements.add(new AchievementBuilder("Gone Fishing", 0, true).requirement("Fishing", 15).build());
        achievements.add(new AchievementBuilder("Going on a Summer Holiday", 0, true).requirement("Coins", 30).build());
        achievements.add(new AchievementBuilder("Dukes of Khazard", 0, true).encounter(new Encounter("Gnome troop")).build());
        ...
        achievements.add(new AchievementBuilder("What, a Melon?", 0.05, true).requirement("Watermelon seed", 3).requirement("Farming", 47)
        ...
        achievements.add(new AchievementBuilder("Volatile Valuables", 0.05, true).requirement("Kennith's Concerns", 1)
        ...
        achievements.add(new AchievementBuilder("Druidic Ritual", 0.25, false).requirement("Coins", 1).requirement("Vial", 1)
            .reward("Quest points", 4).reward("Herblore", 250).reward("Grimy guam", 15).reward("Eye of newt", 15).build());
        achievements.add(new AchievementBuilder("Meeting History", 0.75, false).requirement("Making History", 1)
        ...
        achievements.add(new AchievementBuilder("Sea Slug", 0.5, false).requirement("Firemaking", 30).requirement("Swamp paste", 1)
        ...
        achievements.add(new AchievementBuilder("The Hand in the Sand", 0.75, false).requirement("Thieving", 17).requirement("Crafting", 49)
        ...
        achievements.add(new AchievementBuilder("By the Bucketload", 0, true).requirement("The Hand in the Sand", 1)
            .reward("Bucket of sand", 84).build());
        achievements.add(new AchievementBuilder("Enlightened Journey", 0.75, false).requirement("Quest points", 21)
        ...
        achievements.add(new AchievementBuilder("Castle Wars balloon route", 0.05, false).requirement("Enlightened Journey", 1)
        ...
        achievements.add(new AchievementBuilder("Arise from the Ash", 0, true).requirement("In Pyre Need", 1).requirement("Phoenix Lair", 1)
            .build());
        achievements.add(new AchievementBuilder("Crafting Guild balloon route", 0.05, false).requirement("Enlightened Journey", 1)
            .requirement("Firemaking", 30).requirement("Oak logs", 10).reward("Firemaking", 2000).build());
        achievements.add(new AchievementBuilder("Varrock balloon route", 0.05, false).requirement("Enlightened Journey", 1)
            .requirement("Firemaking", 40).requirement("Willow logs", 10).reward("Firemaking", 2000).build());
        achievements.add(new AchievementBuilder("Grand Tree balloon route", 0.05, false).requirement("Enlightened Journey", 1)
            .requirement("Firemaking", 60).requirement("Magic logs", 3).reward("Firemaking", 2000).build());
        achievements.add(new AchievementBuilder("Around the World in Six Ways", 0, true).requirement("Crafting Guild balloon route", 1)
        ...
        achievements.add(new AchievementBuilder("At Home on the Range", 0, true).requirement("Combat bracelet (4)", 1)
        ...
        achievements.add(new AchievementBuilder("Bar Crawl", 0.5, false).requirement("Coins", 208).build());
        ...
        achievements.add(new AchievementBuilder("You Really Don't Need Any More Shoes", 0, true).requirement("The Fremennik Trials", 1)
            .build());
        achievements.add(new AchievementBuilder("Creature of Fenkenstrain", 0.75, false).requirement("Priest in Peril", 1)
        ...
        achievements.add(new AchievementBuilder("Garden of Tranquility", 1.5, false).requirement("Creature of Fenkenstrain", 1)
        ...
        achievements.add(new AchievementBuilder("You Know You Want It!", 0, true).requirement("Raw bass", 1)
        ...
        achievements.add(new AchievementBuilder("Why Won't You Die?", 0, true).encounter(new Encounter("Rock crab"))
        ...
        achievements.add(new AchievementBuilder("Endangered Species", 0, true).encounter(new Encounter("Black unicorn")).build());
        ...
        achievements.add(new AchievementBuilder("Death Plateau", 0.25, false).encounter(new Encounter("The Map")).reward("Quest points", 1)
            .reward("Rabbit sandwich", 4).lamp(Player.ALL_SKILLS, 100, 1).lamp(Player.ALL_SKILLS, 100, 1).lamp(Player.ALL_SKILLS, 100, 1)
            .build());
        achievements.add(new AchievementBuilder("Troll Stronghold", 0.5, false).requirement("Death Plateau", 1).requirement("Agility", 15)
        ...
        achievements.add(new AchievementBuilder("Eadgar's Ruse", 1.5, false).requirement("Druidic Ritual", 1)
        ...
        achievements.add(new AchievementBuilder("Dream Mentor", 0.55, false).requirement("Lunar Diplomacy", 1)
        ...
        achievements.add(new AchievementBuilder("Axe'll Grease", 0, true).requirement("Blood Runs Deep", 1)
        ...
        achievements.add(new AchievementBuilder("The Tourist Trap", 1, false).requirement("Fletching", 10).requirement("Smithing", 20)
        ...
        achievements.add(new AchievementBuilder("The Dig Site", 1.5, false).requirement("Thieving", 25).requirement("Agility", 10)
        ...
        achievements.add(new AchievementBuilder("Ice gloves", 0.05, false).requirement("Mining", 50).encounter(new Encounter("Ice Queen"))
            .build());
        achievements.add(new AchievementBuilder("Desert Treasure", 2.5, false).requirement("The Dig Site", 1)
        ...
        achievements.add(new AchievementBuilder("Belter of a Smelter", 0, true).requirement("Iron ore", 1).requirement("Coal", 2)
            .requirement("Smithing", 30).reward("Steel bar", 1).reward("Smithing", 17).build());
        achievements.add(new AchievementBuilder("Best Offence", 0, true).encounter(new Encounter("Kalphite King")).build());
        ...
        achievements.add(new AchievementBuilder("Big Chinchompa", 0.25, true).requirement("Hunter", 78).reward("Competence points", 1111)
            .build());
        achievements.add(new AchievementBuilder("Bipedal Mask", 0, true).requirement("Tuska mask headpiece", 1)
        ...
        achievements.add(new AchievementBuilder("Blinded with Science", 0, true).requirement("Firemaking", 49)
        ...
        achievements.add(new AchievementBuilder("Blooming Marvellous", 0, true).requirement("Nature Spirit", 1)
        ...
        achievements.add(new AchievementBuilder("Bovine Intervention", 0, true).encounter(new Encounter("Cow")).build());
        ...
        achievements.add(new AchievementBuilder("Bridge over Fremmy Waters", 0, true).requirement("Fremennik sagas", 5).build());
        ...
        achievements.add(new AchievementBuilder("Burning Bush", 0, true).requirement("Poison ivy seed", 1).requirement("Farming", 70)
        ...
        achievements.add(new AchievementBuilder("Buyers and Cellars", 0.5, false).requirement("Thieving", 5).reward("Quest points", 1)
        ...
        achievements.add(new AchievementBuilder("Buying Up Ancient Artefacts", 0, true).requirement("Desert Treasure", 1)
        ...
        achievements.add(new AchievementBuilder("One Piercing Note", 1, false).reward("Quest points", 2).reward("Prayer", 250).build());
        achievements.add(new AchievementBuilder("Cecilia, I'm Begging You, Please...", 0, true).requirement("One Piercing Note", 1)
            .build());
        ...
        achievements.add(new AchievementBuilder("Change of a Dress", 0, true).requirement("Dungeoneering", 20).build());
        ...
        achievements.add(new AchievementBuilder("Chiselin' Conchiolin", 0, true).requirement("Blamish myre shell (round)", 1)
        ...
        achievements.add(new AchievementBuilder("Classic Rock", 0, true).encounter(new Encounter("Vorago",
        ...
        achievements.add(new AchievementBuilder("Hefin and Puffin'", 0, true).requirement("Plague's End", 1).requirement("Agility", 77)
            .build());
        achievements.add(new AchievementBuilder("Disco Impling", 0, true).requirement("Plague's End", 1).requirement("Daffyd implings", 10)
            .build());
        ...
        achievements.add(new AchievementBuilder("Deadliest Catch", 0.5, false).requirement("Druidic Ritual", 1)
        ...
        achievements.add(new AchievementBuilder("Papa Pawya", 0.05, true).requirement("Papaya tree seed", 1).requirement("Hunter", 66)
        ...
        achievements.add(new AchievementBuilder("Harrowed Lands", 0, true).requirement("Tirannwn Set Tasks - Easy", 1)
            .requirement("Clean harralander", 1).requirement("Herblore", 44).reward("Herblore", 72).reward("Harralander tar", 15)
            .build());
        achievements.add(new AchievementBuilder("The Prisoner of Glouphrie", 0.75, false).requirement("The Path of Glouphrie", 1)
        ...
        achievements.add(new AchievementBuilder("The Eyes of Glouphrie", 0.75, false).requirement("The Grand Tree", 1)
        ...
        achievements.add(new AchievementBuilder("The Expensive Range", 0.05, true).requirement("Crafting", 89).requirement("Mining", 81)
        ...
        achievements.add(new AchievementBuilder("Respect Your Elders", 0.05, true).requirement("Elder seed", 1)
        ...
        achievements.add(new AchievementBuilder("The Elder Kiln", 1.5, false).requirement("Magic", 75).requirement("Agility", 60)
        ...
        achievements.add(new AchievementBuilder("Icthlarin's Little Helper", 1.5, false).requirement("Diamond in the Rough", 1)
        ...
        achievements.add(new AchievementBuilder("A Tail of Two Cats", 1.5, false).requirement("Icthlarin's Little Helper", 1)
        ...
        achievements.add(new AchievementBuilder("Missing, Presumed Death", 1, false).encounter(new Encounter(Collections.singletonList(
            ...
            .reward("Prayer", 500).reward("Agility", 1000).lamp(Arrays.asList("Attack", "Strength", "Defense", "Constitution", "Magic",
                "Ranged"), 1500, 1).build());
        achievements.add(new AchievementBuilder("One of a Kind", 2, false).requirement("A Tail of Two Cats", 1)
        ...
        achievements.add(new AchievementBuilder("The Branches of Darkmeyer", 1.5, false).requirement("Legacy of Seergaze", 1)
        ...
        achievements.add(new AchievementBuilder("Spirit of Summer", 1.5, false).requirement("The Restless Ghost", 1)
            ...
            .build());
        achievements.add(new AchievementBuilder("Summer's End", 1, false).requirement("Spirit of Summer", 1).requirement("Summoning", 23)
        ...
        achievements.add(new AchievementBuilder("Smooth Bakriminel", 0, true).requirement("Coins", 2000).requirement("Woodcutting", 85)
            .requirement("Fletching", 93).reward("Woodcutting", 320).reward("Fletching", 130).reward("Bakriminel bolts", 10).build());
        achievements.add(new AchievementBuilder("Rev-enge!", 0, true).encounter(new Encounter("Revenant imp"))
        ...
        achievements.add(new AchievementBuilder("Ratcatchers", 1.5, false).requirement("Icthlarin's Little Helper", 1)
        ...
        achievements.add(new AchievementBuilder("With a Ten-foot Pole", 0.05, true).requirement("Ratcatchers", 1).build());
        achievements.add(new AchievementBuilder("What Lies Below", 0.5, false).requirement("Rune Mysteries", 1)
        ...
        achievements.add(new AchievementBuilder("Stay Secure", 0.05, true).reward("Coins", 10000).build());
        achievements.add(new AchievementBuilder("Unlocking Your Emotions", 0, true).requirement("Stay Secure", 1).build());
        ...
        achievements.add(new AchievementBuilder("Digsite pendant unlock", 0.5, false).requirement("The Dig Site", 1).build());
        achievements.add(new AchievementBuilder("Return to Senntisten", 0, true).requirement("Digsite pendant unlock", 1)
        ...
        achievements.add(new AchievementBuilder("Family Crest", 0.75, false).requirement("Crafting", 40).requirement("Smithing", 40)
        ...
        achievements.add(new AchievementBuilder("Nomad's Requiem", 0.85, false).requirement("King's Ransom", 1)
        ...
        achievements.add(new AchievementBuilder("Mind Your Back", 0, true).requirement("What Lies Below", 1).requirement("Magic", 80)
            .build());
        achievements.add(new AchievementBuilder("It All Adze Up", 0.05, true).requirement("Inferno adze", 0).requirement("Acorn", 1)
        ...
        achievements.add(new AchievementBuilder("Journey to the Centre of the Earth Altar", 0, true).requirement("Earth talisman", 0)
            .build());
        ...
        achievements.add(new AchievementBuilder("Jute Alors!", 0, true).requirement("Farming", 13).requirement("Jute seed", 3)
        ...
        achievements.add(new AchievementBuilder("Scorpion Catcher", 0.25, false).requirement("Bar Crawl", 1).requirement("Prayer", 31)
        ...
        achievements.add(new AchievementBuilder("Struck A-Ghast", 0, true).requirement("Nature Spirit", 1)
        ...
        achievements.add(new AchievementBuilder("If It Bleeds...", 0, true).encounter(new Encounter("Bat")).build());
        ...
        achievements.add(new AchievementBuilder("Cranius Lupus", 0.05, true).requirement("Agility", 25)
            .requirement("Creature of Fenkenstrain", 1).reward("Agility", 750).build());
        achievements.add(new AchievementBuilder("Morytania Set Tasks - Easy", 0, true).requirement("Chiselin' Conchiolin", 1)
        ...
        achievements.add(new AchievementBuilder("Thoroughly A-Ghast", 0, true).requirement("Temple Trekking total level", 594)
        ...
        achievements.add(new AchievementBuilder("Not Such a Rotten Idea", 0, true).requirement("Games necklace (8)", 1)
        ...
        achievements.add(new AchievementBuilder("They'll Just Throw It Away Again", 0, true).requirement("Creature of Fenkenstrain", 1)
            .requirement("Agility", 60).reward("Agility", 540).build());
        achievements.add(new AchievementBuilder("Shade-Shattering Ka-Bloom", 0, true).requirement("Legacy of Seergaze", 1)
        ...
        achievements.add(new AchievementBuilder("Huge Success", 0, true).requirement("Desert Treasure", 1).requirement("Construction", 50)
        ...
        achievements.add(new AchievementBuilder("Ghosts Ahoy", 0.25, false).requirement("Priest in Peril", 1)
        ...
        achievements.add(new AchievementBuilder("Travelling on the Slime Trail", 0, true).requirement("Ghosts Ahoy", 1).build());
        ...
        achievements.add(new AchievementBuilder("Haunted Mine", 1.5, false).requirement("Priest in Peril", 1)
        ...
        achievements.add(new AchievementBuilder("Dwarf Cannon", 0.75, false).reward("Quest points", 1).reward("Crafting", 750).build());
        ...
        achievements.add(new AchievementBuilder("'Phite Club", 0, true).requirement("'Phite Club (quest)", 1).build());
        achievements.add(new AchievementBuilder("Our Man in the North", 0, true).requirement("Our Man in the North (quest)", 1).build());
        achievements.add(new AchievementBuilder("The Jack of Spades", 0.5, true).requirement("Diamond in the Rough", 1)
            .reward("Agility", 500).reward("Quest points", 1).reward("Construction", 500).reward("Dungeoneering", 500)
            .reward("Thieving", 500).build());
        achievements.add(new AchievementBuilder("The Golem", 0.75, false).requirement("Crafting", 20).requirement("Thieving", 25)
        ...
        achievements.add(new AchievementBuilder("Missing My Mummy", 1, false).requirement("The Golem", 1)
            ...
            .build());
        achievements.add(new AchievementBuilder("Crocodile Tears", 0.5, true).requirement("Dealing with Scabaras", 1)
        ...
        achievements.add(new AchievementBuilder("In the Countyard", 0, true).build());
        ...
        achievements.add(new AchievementBuilder("You Doity Rat", 0, true).encounter(new Encounter("Giant rat")).build());
        ...
        achievements.add(new AchievementBuilder("Nowt Tool Look At", 0, true).build());
        ...
        achievements.add(new AchievementBuilder("Klept-Old-Man-ia", 0, true).build());
        ...
        achievements.add(new AchievementBuilder("Draaaaaiiiiiins...", 0, true).encounter(new Encounter("Zombie")).build());
        ...
        achievements.add(new AchievementBuilder("It's a Jungle Ogre", 0, true).encounter(new Encounter("Jogre")).build());
        ...
        achievements.add(new AchievementBuilder("Tai Bwo Wannai Trio", 1.5, false).requirement("Jungle Potion", 1).requirement("Fishing", 5)
        ...
        achievements.add(new AchievementBuilder("Karamja Set Tasks - Hard", 0, true).requirement("Flawless Victory", 1)
            ...
            .lamp(Player.ALL_SKILLS, 10000, 50).build());
        achievements.add(new AchievementBuilder("To Catch a Karambwan", 0, true).requirement("Tai Bwo Wannai Trio", 1)
        ...
        achievements.add(new AchievementBuilder("Dungeons and Dragons", 0, true).requirement("Dragon Slayer", 1).build());
        ...
        achievements.add(new AchievementBuilder("Limber Lumber Jumper", 0, true).requirement("Advanced Barbarian Outpost laps", 250)
        ...
        achievements.add(new AchievementBuilder("Stand and Deliver", 0, true).encounter(new Encounter("Highwayman")).build());
        ...
        achievements.add(new AchievementBuilder("Making My Mind Up", 0, true).requirement("Mind talisman", 1).requirement("Tiara", 1)
            .build());
        achievements.add(new AchievementBuilder("It's Not Wabbit Season", 0, true).encounter(new Encounter("Duck")).build());
        ...
        achievements.add(new AchievementBuilder("Elementary Medicine", 0, true).requirement("Air rune", 1).build());
        ...
        achievements.add(new AchievementBuilder("I Swear I Heard It Scream", 0.05, true).requirement("Magic seed", 1)
        ...
        achievements.add(new AchievementBuilder("Elemental Workshop I", 0.25, false).requirement("Mining", 20).requirement("Smithing", 20)
        ...
        achievements.add(new AchievementBuilder("Mogre miniquest", 0.25, false).requirement("Cooking", 20).requirement("Bucket of water", 1)
        ...
        achievements.add(new AchievementBuilder("The Mogre Mash", 0, true).requirement("Mogre miniquest", 1).requirement("Coins", 60)
        ...
        achievements.add(new AchievementBuilder("It Spoiled My View", 0, true).requirement("Yew seed", 1).requirement("Farming", 60)
            .requirement("Woodcutting", 60).reward("Farming", 7151).reward("Woodcutting", 175).reward("Yew logs", 1).build());
        achievements.add(new AchievementBuilder("It Matches My Eyes", 0, true).requirement("The Hand in the Sand", 1)
        ...
        achievements.add(new AchievementBuilder("Recruitment Drive", 0.75, false).requirement("Herblore", 3).encounter(new Encounter(
        ...
        achievements.add(new AchievementBuilder("Ice the Icy", 0, true).encounter(new Encounter("Ice giant")).build());
        ...
        achievements.add(new AchievementBuilder("The Knight's Sword", 0.25, false).requirement("Mining", 10).requirement("Iron bar", 2)
            .requirement("Redberry pie", 1).reward("Quest points", 1).lamp(Collections.singletonList("Smithing"), 12725, 28).build());
        achievements.add(new AchievementBuilder("Do They Come in Other Colours?", 0.05, true).requirement("The Knight's Sword", 1)
        ...
        achievements.add(new AchievementBuilder("Kookookachat", 0, true).requirement("Stolen Hearts", 1).build());
        ...
        achievements.add(new AchievementBuilder("Sun Shade", 0.35, true).requirement("Nomad's Requiem", 1).requirement("Do No Evil", 1)
        ...
        achievements.add(new AchievementBuilder("As A First Resort", 1.5, false).requirement("Zogre Flesh Eaters", 1)
        ...
        achievements.add(new AchievementBuilder("I'm Super", 0, true).requirement("Mining", 81).requirement("Antifire (3)", 2)
        ...
        achievements.add(new AchievementBuilder("Water on the Brain", 0, true).requirement("Dealing with Scabaras", 1)
        ...
        achievements.add(new AchievementBuilder("Say It, Don't Spray It", 0, true).requirement("Do No Evil", 1).build());
        ...
        achievements.add(new AchievementBuilder("Ability to fletch broads", 0, false).requirement("Slayer point", 300).build());
        ...
        achievements.add(new AchievementBuilder("Ludikeris", 0, true).requirement("Contact!", 1)
        ...
        achievements.add(new AchievementBuilder("Enakhra's Lament", 0.75, false).requirement("Crafting", 50).requirement("Firemaking", 45)
        ...
        achievements.add(new AchievementBuilder("Eagles' Peak (quest)", 0.75, false).requirement("Hunter", 27).requirement("Swamp tar", 1)
        ...
        achievements.add(new AchievementBuilder("Faster than a Speeding Bullet", 0, true).requirement("Eagles' Peak (quest)", 1)
        ...
        achievements.add(new AchievementBuilder("Tales of Old", 0, true).requirement("Fremennik sagas", 1).build());
        ...
        achievements.add(new AchievementBuilder("It's Dangerous to go Alone", 0.05, true).build());
        ...
        achievements.add(new AchievementBuilder("Kinprovements", 0, true).requirement("Dungeoneering token", 323215).build());
        achievements.add(new AchievementBuilder("Hoof Rot", 0.05, true).requirement("Max floor completed", 32).build());
        achievements.add(new AchievementBuilder("Rapid Renewal", 0, false).requirement("Prayer", 65).requirement("Dungeoneering", 65)
        ...
        achievements.add(new AchievementBuilder("Epic Epic", 0, true).requirement("Fremennik sagas", 5).build());
        ...
        achievements.add(new AchievementBuilder("Marm's Armoury", 0, true).requirement("Crafting", 25)
        ...
        achievements.add(new AchievementBuilder("Zarosian Memories", 0.25, true).requirement("Fate of the Gods", 1).build());
        ...
        achievements.add(new AchievementBuilder("What's Mine is Yours", 0.75, false).requirement("Smithing", 5)
        ...
        achievements.add(new AchievementBuilder("Boric task 1", 0.05, false).requirement("What's Mine is Yours", 1)
            .requirement("Mining", 30).requirement("Coal", 30).reward("Mining", 30).lamp(Arrays.asList("Mining", "Smithing"), 4500, 1)
            .build());
        achievements.add(new AchievementBuilder("Boric task 2", 0.1, false).requirement("Boric task 1", 1).requirement("Mining", 40)
            .encounter(new Encounter("Living rock brawler")).encounter(new Encounter("Living rock brawler"))
            .encounter(new Encounter("Living rock brawler")).encounter(new Encounter("Living rock brawler"))
            .encounter(new Encounter("Living rock brawler")).reward("Mining", 3500).lamp(Arrays.asList("Mining", "Smithing"), 10500, 1)
            .build());
        achievements.add(new AchievementBuilder("Boric task 3", 0.1, false).requirement("Boric task 2", 1).requirement("Mining", 60)
            .reward("Mining", 9550).lamp(Arrays.asList("Mining", "Smithing"), 24000, 1).build());
        achievements.add(new AchievementBuilder("Doric task 1", 0.1, false).requirement("What's Mine is Yours", 1)
            .requirement("Smithing", 12).requirement("Bronze bar", 10).reward("Smithing", 620)
            .lamp(Arrays.asList("Mining", "Smithing"), 750, 1).build());
        achievements.add(new AchievementBuilder("Doric task 2", 0.1, false).requirement("Doric task 1", 1).requirement("Death Plateau", 1)
            .requirement("Smithing", 18).requirement("Bronze bar", 26).reward("Smithing", 825)
            .lamp(Arrays.asList("Mining", "Smithing"), 1500, 1).build());
        achievements.add(new AchievementBuilder("Doric task 3", 0.1, false).requirement("Doric task 2", 1).requirement("Smithing", 24)
            .requirement("Iron bar", 25).reward("Smithing", 1375).lamp(Arrays.asList("Mining", "Smithing"), 2250, 1).build());
        achievements.add(new AchievementBuilder("Doric task 4", 0.1, false).requirement("Doric task 3", 1).requirement("Smithing", 30)
            .requirement("Iron ore", 20).reward("Smithing", 3520).lamp(Arrays.asList("Mining", "Smithing"), 4500, 1).build());
        achievements.add(new AchievementBuilder("Doric task 5", 0.1, false).requirement("Doric task 4", 1).requirement("Smithing", 48)
        ...
        achievements.add(new AchievementBuilder("Doric task 6", 0.1, false).requirement("Doric task 5", 1).requirement("Smithing", 59)
            .requirement("Mithril bar", 60).reward("Smithing", 11000).lamp(Arrays.asList("Mining", "Smithing"), 24000, 1).build());
        achievements.add(new AchievementBuilder("Doric task 7", 0.1, false).requirement("Doric task 6", 1).requirement("Smithing", 64)
            .reward("Smithing", 12000).lamp(Arrays.asList("Mining", "Smithing"), 36000, 1).build());
        achievements.add(new AchievementBuilder("Doric task 8", 0.1, false).requirement("Doric task 7", 1).requirement("Smithing", 75)
            .requirement("Adamant bar", 50).reward("Smithing", 23125).lamp(Arrays.asList("Mining", "Smithing"), 60000, 1).build());
        achievements.add(new AchievementBuilder("What's Mine Is Also Doric's", 0, true).requirement("Doric task 8", 1)
        ...
        achievements.add(new AchievementBuilder("Troublesome Crystals", 0.1, true).requirement("Plague's End", 1).build());
        ...
        achievements.add(new AchievementBuilder("Out into the Ourania", 0, true).requirement("Lunar Diplomacy", 1).build());
        ...
        achievements.add(new AchievementBuilder("Master Quester", 0, true).requirement("Quest points", 398).build());
        ...
        achievements.add(new AchievementBuilder("Lunar Master", 0, true).requirement("Produce points", 430000).build());
        ...
        achievements.add(new AchievementBuilder("The Giant Dwarf", 1, false).requirement("Crafting", 12).requirement("Firemaking", 16)
        ...
        achievements.add(new AchievementBuilder("Unlock corporeal components", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 40).requirement("Dwarven currency", 10).build());
        achievements.add(new AchievementBuilder("Unlock Sprinkler MK1", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 50).requirement("Dwarven currency", 25).build());
        achievements.add(new AchievementBuilder("Unlock Mining accumulator", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 50).requirement("Dwarven currency", 25).build());
        achievements.add(new AchievementBuilder("Unlock Book switcher", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 60).requirement("Dwarven currency", 35).build());
        achievements.add(new AchievementBuilder("Unlock Calorie bomb", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 60).requirement("Dwarven currency", 35).build());
        achievements.add(new AchievementBuilder("Unlock Auto sanctifier", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 70).requirement("Dwarven currency", 55).build());
        achievements.add(new AchievementBuilder("Unlock Kinetic cyclone", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 70).requirement("Dwarven currency", 55).build());
        achievements.add(new AchievementBuilder("Unlock Dungeoneering lock melter", 0, false).requirement("The Giant Dwarf", 1)
            .requirement("Invention", 70).requirement("Dwarven currency", 55).build());
        achievements.add(new AchievementBuilder("Goblin Diplomacy", 0.25, false).requirement("Blue dye", 1).requirement("Orange dye", 1)
            .reward("Quest points", 5).reward("Gold bar", 1).reward("Crafting", 200).build());
        achievements.add(new AchievementBuilder("The Lost Tribe", 0.75, false).requirement("Goblin Diplomacy", 1).requirement("Agility", 13)
        ...
        achievements.add(new AchievementBuilder("Death to the Dorgeshuun", 0.75, false).requirement("The Lost Tribe", 1)
        ...
        achievements.add(new AchievementBuilder("Unlock pestiferous components", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 40).requirement("Cave goblin currency", 10).build());
        achievements.add(new AchievementBuilder("Unlock Mechanised chinchompa", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 50).requirement("Cave goblin currency", 25).build());
        achievements.add(new AchievementBuilder("Unlock Woodcutting accumulator", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 50).requirement("Cave goblin currency", 25).build());
        achievements.add(new AchievementBuilder("Unlock B.A.N.K Stander", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 60).requirement("Cave goblin currency", 35).build());
        achievements.add(new AchievementBuilder("Unlock Monkey mind-control helmet", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 60).requirement("Cave goblin currency", 35).build());
        achievements.add(new AchievementBuilder("Unlock Dungeoneering party simulator", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 70).requirement("Cave goblin currency", 55).build());
        achievements.add(new AchievementBuilder("Unlock Electrified box trap", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 70).requirement("Cave goblin currency", 55).build());
        achievements.add(new AchievementBuilder("Unlock Oldak coil", 0, false).requirement("Death to the Dorgeshuun", 1)
            .requirement("Invention", 70).requirement("Cave goblin currency", 55).build());
        achievements.add(new AchievementBuilder("Invention Gives Me the Blues", 0, true).requirement("Unlock corporeal components", 1)
        ...
        achievements.add(new AchievementBuilder("Diaries of the Clans", 0, true).requirement("Hefin Agility Course laps", 160).build());
        achievements.add(new AchievementBuilder("The Curse of Zaros", 1, false).requirement("Desert Treasure", 1)
        ...
        achievements.add(new AchievementBuilder("Thalassus hunt 1", 0.05, false).requirement("Deadliest Catch", 1).reward("Hunter", 2510)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 2", 0.05, false).requirement("Thalassus hunt 1", 1).reward("Hunter", 2990)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 3", 0.05, false).requirement("Thalassus hunt 2", 1).reward("Hunter", 3470)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 4", 0.05, false).requirement("Thalassus hunt 3", 1).reward("Hunter", 3950)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 5", 0.05, false).requirement("Thalassus hunt 4", 1).reward("Hunter", 4430)
            .build());
    }

    private void addAchievementsDZ() {
        achievements.add(new AchievementBuilder("Thalassus hunt 6", 0.05, false).requirement("Thalassus hunt 5", 1).reward("Hunter", 4910)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 7", 0.05, false).requirement("Thalassus hunt 6", 1).reward("Hunter", 5380)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 8", 0.05, false).requirement("Thalassus hunt 7", 1).reward("Hunter", 5860)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 9", 0.05, false).requirement("Thalassus hunt 8", 1).reward("Hunter", 6340)
            .build());
        achievements.add(new AchievementBuilder("Thalassus hunt 10", 0.05, false).requirement("Thalassus hunt 9", 1).reward("Hunter", 6820)
            .build());
        achievements.add(new AchievementBuilder("Deadlier Catch", 0, true).requirement("Thalassus hunt 10", 1).build());
        ...
        achievements.add(new AchievementBuilder("Cormes and Goes", 0, true).encounter(new Encounter(Arrays.asList(Arrays.asList("Airut",
            "Airut", "Charger", "Charger"), Arrays.asList("Airut", "Airut", "Charger", "Charger"),
            Arrays.asList("Airut", "Charger", "Charger", "Charger"), Arrays.asList("Airut", "Airut", "Airut",
                "Charger", "Charger"), Arrays.asList("Airut", "Airut", "Airut", "Airut", "Airut", "Charger",
        ...
        achievements.add(new AchievementBuilder("From Tiny Acorns", 0.25, false).requirement("Buyers and Cellars", 1)
            .requirement("Thieving", 24).reward("Thieving", 1000).build());
        achievements.add(new AchievementBuilder("Lost Her Marbles", 0.75, false).requirement("From Tiny Acorns", 1)
        ...
        achievements.add(new AchievementBuilder("A Guild of Our Own", 0.5, false).requirement("Lost Her Marbles", 1)
        ...
        achievements.add(new AchievementBuilder("Count All Light Fingers", 0, true).requirement("A Guild of Our Own", 1).build());
        ...
        achievements.add(new AchievementBuilder("Book of death", 0, false).requirement("Reaper point", 500).build());
        achievements.add(new AchievementBuilder("Reaper's choice", 0, false).requirement("Reaper point", 250).build());
        achievements.add(new AchievementBuilder("Rainbow loot beam", 0, false).requirement("Reaper point", 75).build());
        achievements.add(new AchievementBuilder("Grave loot beam", 0, false).requirement("Reaper point", 75).build());
        achievements.add(new AchievementBuilder("Bonfire booster", 0, false).requirement("Reaper point", 250).build());
        achievements.add(new AchievementBuilder("Instance cost", 0, false).requirement("Reaper point", 250).build());
        achievements.add(new AchievementBuilder("Additional tasks", 0, false).requirement("Reaper point", 150).build());
        achievements.add(new AchievementBuilder("Reaper scroll", 0, false).requirement("Reaper point", 250).build());
        achievements.add(new AchievementBuilder("Death's support", 0, false).requirement("Reaper point", 250).build());
        ...
        achievements.add(new AchievementBuilder("Dishonourable Loot", 0, true).requirement("Zamorak hideout loot chests", 6).build());
        achievements.add(new AchievementBuilder("Disowned", 0, true).requirement("Reforged Sunspear", 1).requirement("House Drakan hood", 1)
            ...
            .encounter(new Encounter(Arrays.asList(Collections.singletonList("Vanstrom Klause"),
                Collections.singletonList("Vanstrom Klause")), Arrays.asList(new Restriction("Reforged Sunspear", 1),
        ...
        achievements.add(new AchievementBuilder("Eastern Curiosities storyline", 0.1, false).requirement("Trapper storyline", 1)
            .requirement("Chef storyline", 1).requirement("Architect storyline", 1).build());
        achievements.add(new AchievementBuilder("Eastern Adventurer", 0, true).requirement("Quin storyline", 1)
        ...
        achievements.add(new AchievementBuilder("Finish Him!", 0, true).encounter(new Encounter("Vorago")).build());
        ...
        achievements.add(new AchievementBuilder("Sheep Shearer", 0.25, true).reward("Coins", 2000).reward("Crafting", 150).build());
        ...
        achievements.add(new AchievementBuilder("How Many Games?", 0, true).requirement("Gold Castle Wars ticket", 4150).build());
        ...
        achievements.add(new AchievementBuilder("I Presume These Rewards Are Mine, Death?", 0, true)
        ...
        achievements.add(new AchievementBuilder("Ivan is Flailing", 0, true).requirement("Vyre corpses burned", 500).build());
        ...
        achievements.add(new AchievementBuilder("Kaiki's Tusks", 0, true).requirement("Kaigi's journal", 1)
        ...
        achievements.add(new AchievementBuilder("Maria, You Gotta See Her", 0, true).requirement("Broken Home challenge 1", 1)
        ...
        achievements.add(new AchievementBuilder("Master Bogreman", 0, true).requirement("Chompy kills", 30).build());
        ...
        achievements.add(new AchievementBuilder("Witch's Potion", 0.25, true).requirement("Cooked meat", 1).requirement("Eye of newt", 1)
        ...
        achievements.add(new AchievementBuilder("Song from the Depths", 0.5, false).reward("Quest points", 1).reward("Constitution", 700)
            .build());
        ...
        achievements.add(new AchievementBuilder("About 'Kin Time", 0, true).requirement("Rebuilding Edgeville", 1).build());
        ...
        achievements.add(new AchievementBuilder("Barbarian Assault attacker rank 2", 0, false).requirement("Honour Points", 200).build());
        achievements.add(new AchievementBuilder("Barbarian Assault attacker rank 3", 0, false)
            .requirement("Barbarian Assault attacker rank 2", 1).requirement("Honour Points", 300).build());
        achievements.add(new AchievementBuilder("Barbarian Assault attacker rank 4", 0, false)
            .requirement("Barbarian Assault attacker rank 3", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Barbarian Assault attacker rank 5", 0, false)
            .requirement("Barbarian Assault attacker rank 4", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Barbarian Assault defender rank 2", 0, false).requirement("Honour Points", 200).build());
        achievements.add(new AchievementBuilder("Barbarian Assault defender rank 3", 0, false)
            .requirement("Barbarian Assault defender rank 2", 1).requirement("Honour Points", 300).build());
        achievements.add(new AchievementBuilder("Barbarian Assault defender rank 4", 0, false)
            .requirement("Barbarian Assault defender rank 3", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Barbarian Assault defender rank 5", 0, false)
            .requirement("Barbarian Assault defender rank 4", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Barbarian Assault collector rank 2", 0, false).requirement("Honour Points", 200).build());
        achievements.add(new AchievementBuilder("Barbarian Assault collector rank 3", 0, false)
            .requirement("Barbarian Assault collector rank 2", 1).requirement("Honour Points", 300).build());
        achievements.add(new AchievementBuilder("Barbarian Assault collector rank 4", 0, false)
            .requirement("Barbarian Assault collector rank 3", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Barbarian Assault collector rank 5", 0, false)
            .requirement("Barbarian Assault collector rank 4", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Barbarian Assault healer rank 2", 0, false).requirement("Honour Points", 200).build());
        achievements.add(new AchievementBuilder("Barbarian Assault healer rank 3", 0, false)
            .requirement("Barbarian Assault healer rank 2", 1).requirement("Honour Points", 300).build());
        achievements.add(new AchievementBuilder("Barbarian Assault healer rank 4", 0, false)
            .requirement("Barbarian Assault healer rank 3", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Barbarian Assault healer rank 5", 0, false)
            .requirement("Barbarian Assault healer rank 4", 1).requirement("Honour Points", 400).build());
        achievements.add(new AchievementBuilder("Master of Assault", 0, true).requirement("Barbarian Assault attacker rank 5", 1)
        ...
        achievements.add(new AchievementBuilder("Mazcab Teleport", 0, true).requirement("Teci", 2000).build());
        achievements.add(new AchievementBuilder("Mega Ducklings", 0, true).requirement("Mega ducklings", 1).build());
        achievements.add(new AchievementBuilder("Memorialised More Than Once", 0, true).requirement("Memorial to Guthix", 3).build());
        ...
        achievements.add(new AchievementBuilder("Milk of Chocolate, Snape of Grass", 0, true).requirement("Cooking", 20)
        ...
        achievements.add(new AchievementBuilder("Naturist", 0, true).encounter(new Encounter("Chaos Elemental")).build());
        achievements.add(new AchievementBuilder("Never Eat Silk Worms", 0, true).encounter(new Encounter("Kalphite King")).build());
        ...
        achievements.add(new AchievementBuilder("Next to No Power", 0, true).requirement("Frozen key", 1).encounter(new Encounter("Nex",
        ...
        achievements.add(new AchievementBuilder("Open Bar", 0, true).requirement("Asgarnian ale", 0).requirement("Asgarnian ale (m)", 0)
        ...
        achievements.add(new AchievementBuilder("Who's Your Daddy?", 0, true).requirement("The Fremennik Trials", 1)
        ...
        achievements.add(new AchievementBuilder("Who Do Broodoo?", 0.15, true).encounter(new Encounter("Broodoo victim",
