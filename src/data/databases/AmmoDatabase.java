...
public class AmmoDatabase {
    ...
    private void addAmmos() {
        ...
        ammos.add(new Ammo("Bronze arrow", "Ranged", "Arrows", 48, ImmutableMap.of("Bronze arrow", 1), new ArrayList<>()));
        ammos.add(new Ammo("Bronze bolts", "Ranged", "Bolts", 48, ImmutableMap.of("Bronze bolts", 1), new ArrayList<>()));
        ammos.add(new Ammo("Air Strike", "Magic", "Air", 153, ImmutableMap.of("Air rune", 1), new ArrayList<>()));
       ...
       // ammos.add(new Ammo("Fire Strike", "Magic", "Fire", 326, Map.of("Fire rune", 1, "Air rune", 1)));
        ...
        ammos.add(new Ammo("Air Surge", "Magic", "Air", 2056, ImmutableMap.of("Air rune", 5), Collections.singletonList(new Requirement("Magic", 81))));
    }
