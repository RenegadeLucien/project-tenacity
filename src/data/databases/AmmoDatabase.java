...
public class AmmoDatabase {
    ...
    private void addAmmos() {
        ammos.add(new Ammo("None", "None", "None", 0, new HashMap<>()));

        /*ammos.add(new Ammo("Bronze arrow", "Ranged", "Arrows", 48, Map.of("Bronze arrow", 1)));
        ammos.add(new Ammo("Bronze bolts", "Ranged", "Bolts", 48, Map.of("Bronze bolts", 1)));
        ammos.add(new Ammo("Air Strike", "Magic", "Air", 153, Map.of("Air rune", 1)));
        ...
        ammos.add(new Ammo("Air Surge", "Magic", "Air", 2056, Map.of("Air rune", 5)));
    }
