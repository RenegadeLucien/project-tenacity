...
public class ArmourDatabase {
    ...
    private void addArmours() {
        ...
        armours.add(new Armour("Iron chainbody", "Melee", "Torso", 41, 0, 0, 0.0016, 0, Collections.singletonList(new Requirement("Defence", 10))));
        ...
        armours.add(new Armour("Achto Teralith Helmet", "Melee", "Head", 491, 420, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Teralith Cuirass", "Melee", "Torso", 565, 840, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Teralith Leggings", "Melee", "Legs", 540, 630, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Teralith Gauntlets", "Melee", "Hands", 122, 0, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Teralith Boots", "Melee", "Feet", 122, 0, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Tempest Cowl", "Ranged", "Head", 491, 420, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Tempest Body", "Ranged", "Torso", 565, 840, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Tempest Chaps", "Ranged", "Legs", 540, 630, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Tempest Gloves", "Ranged", "Hands", 122, 0, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Tempest Boots", "Ranged", "Feet", 122, 0, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Primeval Mask", "Magic", "Head", 491, 420, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Primeval robe top", "Magic", "Torso", 565, 840, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Primeval robe legs", "Magic", "Legs", 540, 630, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Primeval Gloves", "Magic", "Hands", 122, 0, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
        armours.add(new Armour("Achto Primeval Boots", "Magic", "Feet", 122, 0, 0, 0.018, 0, Collections.singletonList(new Requirement("Defence", 90))));
