...
public class WeaponDatabase {
    ...
    private void addWeapons() {
        ...
        weapons.add(new Weapon("Bronze claw", "Melee", "Slash", "Mainhand", 48, 150, 4, 0, 0, 0, new ArrayList<>()));
        ...
        weapons.add(new Weapon("Iron claw", "Melee", "Slash", "Mainhand", 96, 202, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        ...
        weapons.add(new Weapon("Rune claw", "Melee", "Slash", "Mainhand", 480, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        ...
        //Melee off-hand (done)
        weapons.add(new Weapon("Off-hand bronze dagger", "Melee", "Stab", "Off-hand", 24, 150, 4, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Off-hand bronze claw", "Melee", "Slash", "Off-hand", 24, 150, 4, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Off-hand bronze mace", "Melee", "Crush", "Off-hand", 24, 150, 4, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Off-hand bronze sword", "Melee", "Stab", "Off-hand", 30, 150, 5, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Off-hand bronze longsword", "Melee", "Slash", "Off-hand", 30, 150, 5, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Off-hand bronze battleaxe", "Melee", "Slash", "Off-hand", 37, 150, 6, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Off-hand bronze warhammer", "Melee", "Crush", "Off-hand", 37, 150, 6, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Off-hand iron dagger", "Melee", "Stab", "Off-hand", 48, 202, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Off-hand iron claw", "Melee", "Slash", "Off-hand", 48, 202, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Off-hand iron mace", "Melee", "Crush", "Off-hand", 48, 202, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Off-hand iron sword", "Melee", "Stab", "Off-hand", 61, 202, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Off-hand iron longsword", "Melee", "Slash", "Off-hand", 61, 202, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Off-hand iron battleaxe", "Melee", "Slash", "Off-hand", 74, 202, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Off-hand iron warhammer", "Melee", "Crush", "Off-hand", 74, 202, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Off-hand steel dagger", "Melee", "Stab", "Off-hand", 96, 316, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Off-hand steel claw", "Melee", "Slash", "Off-hand", 96, 316, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Off-hand steel mace", "Melee", "Crush", "Off-hand", 96, 316, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Off-hand steel sword", "Melee", "Stab", "Off-hand", 122, 316, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Off-hand steel longsword", "Melee", "Slash", "Off-hand", 122, 316, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Off-hand steel battleaxe", "Melee", "Slash", "Off-hand", 149, 316, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Off-hand steel warhammer", "Melee", "Crush", "Off-hand", 149, 316, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        ...
        weapons.add(new Weapon("Off-hand mithril dagger", "Melee", "Stab", "Off-hand", 144, 454, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Off-hand mithril claw", "Melee", "Slash", "Off-hand", 144, 454, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Off-hand mithril mace", "Melee", "Crush", "Off-hand", 144, 454, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Off-hand mithril sword", "Melee", "Stab", "Off-hand", 183, 454, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Off-hand mithril longsword", "Melee", "Slash", "Off-hand", 183, 454, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Off-hand mithril battleaxe", "Melee", "Slash", "Off-hand", 223, 454, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Off-hand mithril warhammer", "Melee", "Crush", "Off-hand", 223, 454, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Off-hand adamant dagger", "Melee", "Stab", "Off-hand", 192, 628, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Off-hand adamant claw", "Melee", "Slash", "Off-hand", 192, 628, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Off-hand adamant mace", "Melee", "Crush", "Off-hand", 192, 628, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Off-hand adamant sword", "Melee", "Stab", "Off-hand", 245, 628, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Off-hand adamant longsword", "Melee", "Slash", "Off-hand", 245, 628, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Off-hand adamant battleaxe", "Melee", "Slash", "Off-hand", 298, 628, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Off-hand adamant warhammer", "Melee", "Crush", "Off-hand", 298, 628, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Off-hand rune dagger", "Melee", "Stab", "Off-hand", 240, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Off-hand rune claw", "Melee", "Slash", "Off-hand", 240, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Off-hand rune mace", "Melee", "Crush", "Off-hand", 240, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Off-hand rune sword", "Melee", "Stab", "Off-hand", 306, 850, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Off-hand rune longsword", "Melee", "Slash", "Off-hand", 306, 850, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Off-hand rune battleaxe", "Melee", "Slash", "Off-hand", 372, 850, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Off-hand rune warhammer", "Melee", "Crush", "Off-hand", 372, 850, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
