...
public class WeaponDatabase {
    ...
    private void addWeapons() {
        ...
        weapons.add(new Weapon("Rune scimitar", "Melee", "Slash", "Mainhand", 480, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        ...
        //Melee off-hand (done)
        weapons.add(new Weapon("Bronze off hand dagger", "Melee", "Stab", "Off-hand", 24, 150, 4, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Bronze off hand claws", "Melee", "Slash", "Off-hand", 24, 150, 4, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Bronze off hand mace", "Melee", "Crush", "Off-hand", 24, 150, 4, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Bronze off hand sword", "Melee", "Stab", "Off-hand", 30, 150, 5, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Bronze off hand longsword", "Melee", "Slash", "Off-hand", 30, 150, 5, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Bronze off hand battleaxe", "Melee", "Slash", "Off-hand", 37, 150, 6, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Bronze off hand warhammer", "Melee", "Crush", "Off-hand", 37, 150, 6, 0, 0, 0, new ArrayList<>()));
        weapons.add(new Weapon("Iron off hand dagger", "Melee", "Stab", "Off-hand", 48, 202, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Iron off hand claws", "Melee", "Slash", "Off-hand", 48, 202, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Iron off hand mace", "Melee", "Crush", "Off-hand", 48, 202, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Iron off hand sword", "Melee", "Stab", "Off-hand", 61, 202, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Iron off hand longsword", "Melee", "Slash", "Off-hand", 61, 202, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Iron off hand battleaxe", "Melee", "Slash", "Off-hand", 74, 202, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Iron off hand warhammer", "Melee", "Crush", "Off-hand", 74, 202, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 10))));
        weapons.add(new Weapon("Steel off hand dagger", "Melee", "Stab", "Off-hand", 96, 316, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Steel off hand claws", "Melee", "Slash", "Off-hand", 96, 316, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Steel off hand mace", "Melee", "Crush", "Off-hand", 96, 316, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Steel off hand sword", "Melee", "Stab", "Off-hand", 122, 316, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Steel off hand longsword", "Melee", "Slash", "Off-hand", 122, 316, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Steel off hand battleaxe", "Melee", "Slash", "Off-hand", 149, 316, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        weapons.add(new Weapon("Steel off hand warhammer", "Melee", "Crush", "Off-hand", 149, 316, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 20))));
        ...
        weapons.add(new Weapon("Mithril off hand battleaxe", "Melee", "Slash", "Off-hand", 223, 454, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Mithril off hand warhammer", "Melee", "Crush", "Off-hand", 223, 454, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 30))));
        weapons.add(new Weapon("Adamant off hand dagger", "Melee", "Stab", "Off-hand", 192, 628, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Adamant off hand claws", "Melee", "Slash", "Off-hand", 192, 628, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Adamant off hand mace", "Melee", "Crush", "Off-hand", 192, 628, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Adamant off hand sword", "Melee", "Stab", "Off-hand", 245, 628, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Adamant off hand longsword", "Melee", "Slash", "Off-hand", 245, 628, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Adamant off hand battleaxe", "Melee", "Slash", "Off-hand", 298, 628, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Adamant off hand warhammer", "Melee", "Crush", "Off-hand", 298, 628, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 40))));
        weapons.add(new Weapon("Rune off hand dagger", "Melee", "Stab", "Off-hand", 240, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Rune off hand claws", "Melee", "Slash", "Off-hand", 240, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Rune off hand scimitar", "Melee", "Slash", "Off-hand", 240, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Rune off hand mace", "Melee", "Crush", "Off-hand", 240, 850, 4, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Rune off hand sword", "Melee", "Stab", "Off-hand", 306, 850, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Rune off hand longsword", "Melee", "Slash", "Off-hand", 306, 850, 5, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Rune off hand battleaxe", "Melee", "Slash", "Off-hand", 372, 850, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        weapons.add(new Weapon("Rune off hand warhammer", "Melee", "Crush", "Off-hand", 372, 850, 6, 0, 0, 0, Collections.singletonList(new Requirement("Attack", 50))));
        ...
        weapons.add(new Weapon("Guthix staff", "Magic", "Magic", "Two-handed", 0, 1132, 6, 1341, 2, 0, Collections.singletonList(new Requirement("Magic", 60))));
