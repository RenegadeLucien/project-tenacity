...
public class EnemyDatabase {
    ...
    private void addEnemies() {
        ...
        enemies.add(new Enemy("Entranan firebird", 50, 24.9, 8.2, 0, 4, 0, 0, 1, 0, 4, 0, 110, 0, 110, 1, "Slash", 90, 65, 55, 45));
        enemies.add(new Enemy("Cow calf", 50, 24.9, 8.2, 12, 0, 0, 1, 0, 0, 4, 130, 0, 0, 110, 1, "Earth", 80, 60, 50, 80));
        enemies.add(new Enemy("Spider", 50, 24.9, 8.2, 0, 4, 0, 0, 1, 0, 4, 0, 110, 0, 110, 1, "Crush", 80, 70, 60, 50));
        enemies.add(new Enemy("Skeleton (Demon Slayer)", 50, 24.9, 8.2, 0, 4, 0, 0, 1, 0, 4, 0, 110, 0, 110, 1, "Nothing", 0, 60, 60, 60));
        enemies.add(new Enemy("Seagull", 50, 24.9, 8.2, 4, 0, 0, 1, 0, 0, 4, 110, 0, 0, 110, 1, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Rabbit", 50, 24.9, 8.2, 4, 0, 0, 1, 0, 0, 4, 110, 0, 0, 110, 1, "Fire", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Pekin", 50, 24.9, 8.2, 4, 0, 0, 1, 0, 0, 4, 110, 0, 0, 110, 1, "Water", 80, 60, 50, 70));
        ...
        enemies.add(new Enemy("Rooster", 100, 24.9, 8.2, 8, 0, 0, 2, 0, 0, 4, 120, 0, 0, 120, 2, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Ram", 100, 32, 10.5, 8, 0, 0, 2, 0, 0, 4, 120, 0, 0, 120, 2, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Brokeface", 120, 12.7, 4.1, 12, 0, 0, 2, 1, 1, 6, 12, 0, 0, 0, 5, "Crush", 90, 55, 45, 65));
        enemies.add(new Enemy("Gelatinous abomination", 150, 30, 9.9, 0, 0, 12, 0, 0, 3, 4, 0, 0, 130, 130, 3, "Arrows", 90, 60, 80, 70));
        enemies.add(new Enemy("Undead cow", 150, 25.5, 8.4, 12, 0, 0, 3, 0, 0, 4, 130, 0, 0, 130, 3, "Earth", 80, 60, 50, 70));
        enemies.add(new Enemy("Pig", 150, 25.5, 8.4, 12, 0, 0, 3, 0, 0, 4, 130, 0, 0, 130, 3, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Corpse Spider", 150, 25.5, 8.4, 0, 12, 0, 0, 3, 0, 4, 0, 130, 0, 130, 3, "Crush", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Crawling hand", 200, 14.8, 4.8, 32, 0, 0, 8, 0, 0, 4, 181, 0, 0, 181, 8, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Imp", 200, 25.8, 8.5, 16, 0, 0, 4, 0, 0, 4, 140, 0, 0, 140, 4, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Bird", 250, 26.7, 8.8, 20, 0, 0, 5, 0, 0, 4, 150, 0, 0, 150, 5, "Earth", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Cave bug", 300, 27.6, 9.1, 0, 24, 0, 0, 6, 0, 4, 0, 160, 0, 160, 6, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Adolescent White wolf", 300, 27.6, 9.1, 24, 0, 0, 6, 0, 0, 4, 160, 0, 0, 160, 6, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Desert snake", 300, 27.6, 9.1, 0, 24, 0, 0, 6, 0, 4, 0, 160, 0, 160, 6, "Slash", 90, 65, 55, 45));
        enemies.add(new Enemy("Wight", 350, 26.7, 8.8, 25, 0, 0, 5, 0, 0, 5, 150, 0, 0, 150, 5, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Dwarf", 350, 28.2, 9.3, 28, 0, 0, 7, 0, 0, 4, 171, 0, 0, 171, 7, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Grave scorpion", 350, 28.2, 9.3, 21, 28, 0, 5, 7, 0, 4, 52, 171, 0, 171, 7, "Crush", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Bear cub", 400, 29.7, 9.8, 32, 0, 0, 8, 0, 0, 4, 181, 0, 0, 181, 8, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Zombie", 450, 30.9, 10.1, 36, 0, 0, 9, 0, 0, 4, 191, 0, 0, 191, 9, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Ghost (Melzar's Maze)", 450, 30.9, 10.1, 36, 0, 0, 9, 0, 0, 4, 191, 0, 0, 191, 9, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Skeleton (Melzar's Maze)", 450, 30.9, 10.1, 36, 0, 0, 9, 0, 0, 4, 191, 0, 0, 191, 9, "Earth", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Scorpion", 500, 32.1, 10.5, 30, 40, 0, 10, 10, 0, 4, 202, 202, 0, 202, 10, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Death spawn", 500, 199.5, 65.8, 0, 0, 10, 0, 0, 68, 4, 0, 0, 1409, 316, 20, "Crush", 90, 45, 65, 55));
        enemies.add(new Enemy("Skeleton", 550, 33.9, 11.1, 44, 0, 0, 11, 0, 0, 4, 213, 0, 0, 213, 11, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Desert wolf", 550, 33.9, 11.1, 44, 0, 0, 11, 0, 0, 4, 213, 0, 0, 213, 11, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Unicorn", 550, 33.9, 11.1, 0, 0, 44, 0, 0, 11, 4, 0, 0, 213, 213, 11, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Warped bat", 600, 35.7, 11.7, 0, 0, 48, 0, 0, 12, 4, 0, 0, 223, 223, 12, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Skeleton Mage", 700, 36.6, 12, 0, 0, 56, 0, 0, 14, 4, 0, 0, 245, 245, 14, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Skoblin", 700, 36.6, 12, 56, 0, 0, 14, 0, 0, 4, 245, 0, 0, 245, 14, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Snothead", 700, 36.6, 12, 56, 0, 0, 14, 0, 0, 4, 245, 0, 0, 245, 14, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Small Lizard", 750, 37.2, 12.2, 0, 60, 0, 0, 15, 0, 4, 0, 257, 0, 257, 15, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("Kayle", 750, 199.2, 65.7, 0, 6, 0, 0, 1, 0, 4, 0, 110, 0, 110, 1, "Slash", 90, 65, 55, 45));
        enemies.add(new Enemy("Caitlin", 750, 199.2, 65.7, 0, 0, 6, 0, 0, 1, 4, 0, 0, 110, 110, 1, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Reese", 750, 199.2, 65.7, 6, 0, 0, 1, 0, 0, 4, 110, 0, 0, 110, 1, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Monk of Zamorak", 850, 39.6, 13, 0, 0, 68, 0, 0, 17, 4, 0, 0, 280, 280, 17, "Arrows", 90, 55, 45, 65));
        enemies.add(new Enemy("Black bear", 850, 39.6, 13, 68, 0, 0, 17, 0, 0, 4, 280, 0, 0, 280, 17, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Skeleton fremennik", 850, 39.6, 13, 102, 0, 0, 17, 0, 0, 6, 280, 0, 0, 280, 17, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Ghost", 900, 40.8, 13.4, 0, 0, 72, 0, 0, 18, 4, 0, 0, 292, 292, 18, "Thrown", 90, 45, 65, 55));
        enemies.add(new Enemy("Snailfeet", 900, 40.8, 13.4, 54, 72, 0, 13, 18, 0, 4, 135, 292, 0, 292, 18, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Cave slime", 950, 42.6, 14, 0, 76, 0, 0, 19, 0, 4, 0, 304, 0, 304, 19, "Slash", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Grimtern", 1000, 83.4, 27.5, 150, 200, 0, 37, 50, 0, 5, 375, 850, 0, 850, 50, "Slash", 90, 65, 55, 45));
        enemies.add(new Enemy("Young grotworm", 1000, 44.4, 14.6, 0, 0, 140, 0, 0, 20, 7, 0, 0, 316, 316, 20, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Minotaur", 1000, 46.3, 15.2, 96, 0, 0, 10, 0, 0, 4, 202, 0, 0, 202, 10, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Delrith", 1000, 0, 0, 8, 0, 0, 10, 0, 0, 4, 10, 0, 0, 10, 10, "Nothing", 0, 75, 0, 0));
        enemies.add(new Enemy("Ugthanki", 1000, 44.4, 14.6, 80, 0, 0, 20, 0, 0, 4, 316, 0, 0, 316, 20, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Hobgoblin", 1000, 44.4, 14.6, 80, 0, 0, 20, 0, 0, 4, 316, 0, 0, 316, 20, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Crab", 1050, 46.5, 15.3, 84, 0, 0, 21, 0, 0, 4, 329, 0, 0, 329, 21, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Grizzly bear cub", 1050, 46.5, 15.3, 84, 0, 0, 21, 0, 0, 4, 329, 0, 0, 329, 21, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("White wolf", 1100, 48.9, 16.1, 88, 0, 0, 22, 0, 0, 4, 341, 0, 0, 341, 22, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Mosschin", 1100, 48.9, 16.1, 66, 0, 88, 16, 0, 22, 4, 165, 0, 341, 341, 22, "Thrown", 90, 45, 65, 55));
        enemies.add(new Enemy("Outlaw", 1150, 50.4, 16.6, 92, 0, 0, 23, 0, 0, 4, 354, 0, 0, 354, 23, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Grizzly bear", 1150, 50.4, 16.6, 92, 0, 0, 23, 0, 0, 4, 354, 0, 0, 354, 23, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Black Knight", 1200, 51.9, 17.1, 96, 0, 0, 24, 0, 0, 4, 368, 0, 0, 368, 24, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Mudskipper", 1200, 51.9, 17.1, 96, 0, 0, 24, 0, 0, 4, 368, 0, 0, 368, 24, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Guard dog", 1200, 51.9, 17.1, 96, 0, 0, 24, 0, 0, 4, 368, 0, 0, 268, 24, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Angry bear", 1250, 54, 17.8, 100, 0, 0, 25, 0, 0, 4, 381, 0, 0, 381, 25, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Wild dog", 1250, 54, 17.8, 100, 0, 0, 25, 0, 0, 4, 381, 0, 0, 381, 25, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Icefiend", 1250, 54, 17.8, 0, 0, 100, 0, 0, 25, 4, 0, 0, 381, 381, 25, "Thrown", 90, 45, 65, 55));
        enemies.add(new Enemy("Guard (DttD)", 1300, 56.1, 18.5, 104, 0, 0, 26, 0, 0, 4, 395, 0, 0, 395, 26, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Redeyes", 1300, 56.1, 18.5, 78, 0, 104, 19, 0, 26, 4, 195, 0, 395, 395, 26, "Thrown", 90, 45, 65, 55));
        enemies.add(new Enemy("Strongbones", 1300, 56.1, 18.5, 78, 0, 104, 19, 0, 26, 4, 195, 0, 395, 395, 26, "Thrown", 90, 45, 65, 55));
        enemies.add(new Enemy("Big frog", 1300, 56.1, 18.5, 0, 104, 0, 0, 26, 0, 4, 0, 395, 0, 395, 26, "Slash", 90, 65, 55, 45));
        enemies.add(new Enemy("Mounted terrorbird gnome", 1320, 63, 20.7, 264, 0, 0, 33, 0, 0, 4, 502, 0, 0, 502, 33, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Golem Guard", 1350, 58.5, 19.3, 108, 0, 0, 27, 0, 0, 4, 409, 0, 0, 409, 27, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Customs Officer", 1350, 58.5, 19.3, 108, 0, 0, 27, 0, 0, 4, 409, 0, 0, 409, 27, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Banshee", 1350, 58.5, 19.3, 0, 0, 108, 0, 0, 27, 4, 0, 0, 409, 409, 27, "Arrows", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("King Scorpion", 1400, 61.5, 20.2, 84, 112, 0, 21, 28, 0, 4, 329, 424, 0, 424, 28, "Crush", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Terrorbird", 1500, 66.9, 22, 120, 0, 0, 30, 0, 0, 4, 454, 0, 0, 454, 30, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Blessed spider", 1500, 66.9, 22, 90, 120, 0, 22, 30, 0, 4, 225, 454, 0, 454, 30, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Ice spider", 1500, 66.9, 22, 0, 120, 0, 0, 30, 0, 4, 0, 454, 0, 454, 30, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Wolf", 1500, 66.9, 22, 120, 0, 0, 30, 0, 0, 4, 454, 0, 0, 454, 30, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Giant bat", 1600, 72.6, 23.9, 0, 0, 128, 0, 0, 32, 4, 0, 0, 486, 486, 32, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Undead one", 1600, 72.6, 23.9, 192, 0, 0, 32, 0, 0, 4, 486, 0, 0, 486, 32, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Baby blue dragon", 1600, 72.6, 23.9, 0, 0, 128, 0, 0, 32, 4, 0, 0, 486, 486, 32, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Fox", 1600, 72.6, 23.9, 128, 0, 0, 32, 0, 0, 4, 486, 0, 0, 486, 32, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Shadow spider", 1650, 75.9, 25, 0, 132, 0, 0, 33, 0, 4, 0, 502, 0, 502, 33, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Dire Wolf", 1650, 75.9, 25, 132, 0, 0, 33, 0, 0, 4, 502, 0, 0, 502, 33, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Sir Mordred", 1700, 59.4, 19.6, 68, 0, 0, 17, 0, 0, 4, 280, 0, 0, 280, 17, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Black Guard", 1700, 79.8, 26.3, 136, 0, 0, 34, 0, 0, 4, 519, 0, 0, 519, 34, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Chaos dwarf", 1700, 79.8, 26.3, 170, 0, 0, 34, 0, 0, 5, 519, 0, 0, 519, 34, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("River troll", 1700, 172.2, 56.8, 10, 0, 0, 1, 0, 0, 4, 10, 0, 0, 1, 130, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Wall beast", 1700, 79.8, 26.3, 136, 0, 0, 34, 0, 0, 4, 519, 0, 0, 519, 34, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Tumeken's shadow 2", 1750, 83.1, 27.4, 140, 0, 0, 35, 0, 0, 4, 536, 0, 0, 536, 35, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Sorebones", 1750, 83.1, 27.4, 140, 0, 0, 35, 0, 0, 4, 536, 0, 0, 536, 35, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Poison Scorpion", 1750, 83.1, 27.4, 0, 140, 0, 0, 35, 0, 4, 0, 536, 0, 536, 35, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("Skeletal miner", 1750, 83.1, 27.4, 140, 0, 0, 35, 0, 0, 4, 536, 0, 0, 536, 35, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Fenris wolf", 1750, 83.1, 27.4, 140, 0, 0, 35, 0, 0, 4, 536, 0, 0, 536, 35, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Rockslug", 1750, 66.9, 22, 120, 0, 0, 30, 0, 0, 4, 454, 0, 0, 454, 30, "Watier", 90, 55, 45, 65));
        enemies.add(new Enemy("Revenant goblin", 1800, 71.4, 23.5, 270, 270, 270, 12, 12, 12, 5, 223, 223, 223, 223, 12, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Small scarab", 1800, 86.7, 28.6, 108, 144, 0, 27, 36, 0, 4, 409, 553, 0, 553, 36, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Khazard scorpion", 1800, 86.7, 28.6, 0, 14, 0, 0, 36, 0, 4, 0, 553, 0, 553, 36, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Tortoise", 1800, 86.7, 28.6, 144, 0, 0, 36, 0, 0, 4, 553, 0, 0, 553, 36, "Ait", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Vulture", 1900, 95.4, 31.4, 152, 0, 0, 38, 0, 0, 4, 590, 0, 0, 590, 38, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Fire monster", 1900, 95.4, 31.4, 0, 0, 152, 0, 0, 38, 6, 0, 0, 590, 590, 38, "Nothing", 0, 0, 0, 45));
        enemies.add(new Enemy("Lava monster (TTKD)", 1900, 95.4, 31.4, 0, 152, 0, 0, 38, 0, 6, 0, 590, 0, 590, 38, "Nothing", 0, 0, 55, 0));
        ...
        enemies.add(new Enemy("Ice warrior", 1950, 99.3, 32.7, 156, 0, 0, 39, 0, 0, 4, 609, 0, 0, 609, 39, "Fire", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Lesser demon (Melzar's Maze)", 2000, 103.8, 34.2, 120, 0, 160, 30, 0, 40, 4, 454, 0, 628, 628, 40, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Tumeken's shadow 3", 2000, 103.8, 34.2, 160, 0, 0, 40, 0, 0, 4, 628, 0, 0, 628, 40, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Evil spirit", 2000, 103.8, 24.3, 160, 0, 0, 40, 0, 0, 4, 628, 0, 0, 628, 40, "Nothing", 0, 20, 10, 40));
        enemies.add(new Enemy("Pit Scorpion", 2000, 103.8, 34.2, 0, 160, 0, 0, 40, 0, 4, 0, 628, 0, 628, 40, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("H.A.M Mage", 2000, 66.6, 21.9, 0, 0, 144, 0, 0, 20, 6, 0, 0, 316, 316, 20, "Arrows", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Turoth", 2150, 79.6, 26.2, 0, 172, 0, 0, 43, 0, 4, 0, 689, 0, 689, 43, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("Ghostly warrior", 2200, 125.7, 41.4, 176, 0, 0, 44, 0, 0, 4, 710, 0, 0, 710, 44, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Pyrefiend", 2200, 125.7, 41.4, 0, 0, 176, 0, 0, 44, 4, 0, 0, 710, 710, 44, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Feral vampyre", 2200, 125.7, 41.4, 176, 0, 0, 44, 0, 0, 4, 710, 0, 0, 710, 44, "Fire", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Desert Lizard", 2250, 132, 43.5, 0, 180, 0, 0, 45, 0, 4, 0, 732, 0, 732, 45, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("Crypt spider", 2250, 132, 43.5, 270, 0, 0, 45, 0, 0, 6, 732, 0, 0, 732, 45, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Poison spider", 2250, 132, 43.5, 0, 180, 0, 0, 45, 0, 4, 0, 732, 0, 732, 45, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Sea troll", 2250, 132, 43.5, 384, 0, 0, 45, 0, 0, 3, 732, 0, 0, 732, 45, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Werewolf", 2250, 132, 43.5, 225, 0, 0, 45, 0, 0, 5, 732, 0, 0, 732, 45, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Big Snake", 2300, 138.3, 45.6, 184, 0, 0, 46, 0, 0, 4, 755, 0, 0, 755, 46, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Khazard ogre", 2300, 138.3, 45.6, 18, 0, 0, 46, 0, 0, 6, 755, 0, 0, 755, 46, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Ghoul", 2300, 138.3, 45.6, 184, 0, 0, 46, 0, 0, 4, 755, 0, 0, 755, 46, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Shadow warrior", 2350, 145.2, 47.9, 188, 0, 0, 47, 0, 0, 4, 778, 0, 0, 778, 47, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Troll spectator", 2350, 145.2, 47.9, 235, 0, 0, 47, 0, 0, 5, 778, 0, 0, 778, 47, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Shadow Hound", 2400, 151.8, 50, 192, 0, 0, 48, 0, 0, 4, 801, 0, 0, 801, 48, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Ice troll female", 2450, 159.3, 52.5, 147, 196, 0, 36, 49, 0, 4, 367, 825, 0, 825, 49, "Stab", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Trade floor guard", 2500, 166.8, 55, 200, 0, 0, 50, 0, 0, 4, 850, 0, 0, 850, 50, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Chaos dwarf hand cannoneer", 2500, 166.8, 55, 262, 350, 0, 37, 50, 0, 7, 375, 850, 0, 850, 50, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("Zombie champion", 2500, 66.9, 22, 551, 0, 0, 30, 0, 0, 5, 454, 0, 0, 454, 30, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Baby black dragon", 2500, 166.8, 55, 0, 200, 0, 0, 50, 0, 4, 0, 850, 0, 850, 50, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("Rock crab", 2550, 232.5, 76.7, 204, 0, 0, 51, 0, 0, 6, 875, 0, 0, 875, 51, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Ice wolf", 2550, 174.9, 57.7, 204, 0, 0, 51, 0, 0, 4, 875, 0, 0, 875, 51, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Monkey Zombie", 2600, 210, 70, 208, 0, 0, 52, 0, 0, 4, 901, 0, 0, 901, 52, "Air", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Mummy", 2650, 192, 63.3, 212, 0, 0, 53, 0, 0, 4, 928, 0, 0, 928, 53, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Mountain troll", 2700, 201.3, 66.4, 216, 0, 0, 54, 0, 0, 4, 955, 0, 0, 955, 54, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Black Knight guardian", 2750, 211.5, 69.7, 220, 0, 0, 55, 0, 0, 4, 983, 0, 0, 983, 55, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Earth warrior", 2800, 221.7, 73.1, 224, 0, 0, 56, 0, 0, 4, 1011, 0, 0, 1011, 56, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Mourner", 2850, 233.1, 76.9, 228, 0, 0, 57, 0, 0, 4, 1040, 0, 0, 1040, 57, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Monkey Archer", 2850, 233.1, 76.9, 0, 228, 0, 0, 57, 0, 4, 0, 1040, 0, 1040, 57, "Slash", 90, 65, 55, 45));
        enemies.add(new Enemy("Ork warrior", 2850, 233.1, 76.9, 228, 0, 0, 57, 0, 0, 4, 1040, 0, 0, 1040, 57, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Wallasalki", 2850, 261, 86.1, 0, 0, 342, 0, 0, 57, 6, 0, 0, 1040, 1040, 57, "Arrows", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Tenacious toucan", 3000, 269.4, 88.9, 240, 0, 0, 60, 0, 0, 4, 1132, 0, 0, 1132, 60, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Tortured soul", 3000, 95.4, 31.4, 114, 0, 152, 17, 0, 38, 4, 285, 0, 590, 590, 38, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Giant skeleton", 3000, 283.5, 93.5, 240, 0, 0, 60, 0, 0, 4, 1132, 0, 0, 1132, 60, "Earth", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("TzHaar-Hur", 3100, 297.3, 98.1, 310, 0, 0, 62, 0, 0, 5, 1197, 0, 0, 1197, 62, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Monkey Guard", 3200, 327.9, 108.2, 256, 0, 0, 64, 0, 0, 4, 1264, 0, 0, 1264, 64, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Hill giant", 3200, 108, 35.6, 192, 0, 0, 32, 0, 0, 6, 486, 0, 0, 486, 32, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Troll general", 3250, 344.4, 113.6, 260, 0, 0, 65, 0, 0, 4, 1299, 0, 0, 1299, 65, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Mighty banshee", 3250, 344.4, 113.6, 260, 0, 0, 65, 0, 0, 4, 1299, 0, 0, 1299, 54, "Bolts", 90, 55, 45, 65));
        enemies.add(new Enemy("Mercenary axeman", 3250, 344.4, 113.6, 260, 0, 0, 65, 0, 0, 4, 1299, 0, 0, 1299, 65, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Mutated jadinko baby", 3350, 379.8, 125.3, 0, 0, 268, 0, 0, 67, 4, 0, 0, 1372, 1372, 67, "Stab", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Jackal", 3500, 124.6, 41.1, 140, 0, 0, 35, 0, 0, 4, 536, 0, 0, 536, 35, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Baby Roc", 3500, 103.8, 34.2, 160, 0, 0, 40, 0, 0, 4, 628, 0, 0, 628, 40, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Ulfric", 3500, 124.6, 41.1, 210, 0, 0, 35, 0, 0, 6, 536, 0, 0, 536, 35, "Nothing", 0, 40, 40, 40));
        ...
        enemies.add(new Enemy("Moss giant", 3700, 136.3, 44.9, 0, 185, 0, 0, 37, 0, 5, 0, 571, 0, 571, 27, "Slash", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Irvig Senay", 3750, 166.8, 55, 300, 0, 0, 50, 0, 0, 4, 850, 0, 0, 850, 50, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("San Tojalon", 3750, 166.8, 55, 300, 0, 0, 50, 0, 0, 4, 850, 0, 0, 850, 50, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Capsarius", 3750, 564.3, 186.2, 0, 0, 168, 0, 0, 75, 3, 0, 0, 1694, 1694, 75, "Nothing", 0, 14, 70, 30));
        enemies.add(new Enemy("Zombie hand", 3780, 241, 79.5, 216, 0, 0, 54, 0, 0, 4, 955, 0, 0, 955, 54, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Catablepon", 3900, 149, 49.1, 152, 0, 152, 38, 0, 38, 4, 590, 0, 590, 590, 38, "Bolts", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Arzinian Avatar", 4000, 155.7, 51.3, 240, 240, 240, 40, 40, 40, 4, 628, 628, 628, 628, 40, "Nothing", 0, 45, 45, 45));
        enemies.add(new Enemy("Basilisk", 4000, 211.5, 69.7, 220, 0, 0, 55, 0, 0, 4, 983, 0, 0, 983, 55, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Skeleton champion", 4000, 54, 17.8, 183, 459, 0, 10, 25, 0, 5, 202, 381, 0, 318, 25, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Banshee champion", 4000, 132, 43.5, 0, 0, 826, 0, 0, 45, 5, 0, 0, 732, 732, 45, "Bolts", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Kalphite Worker", 4200, 179.9, 59.3, 168, 0, 0, 42, 0, 0, 4, 668, 0, 0, 668, 42, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Agrith Naar", 4500, 269.4, 88.9, 264, 0, 264, 60, 0, 60, 4, 1132, 0, 1132, 1132, 60, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Dagannoth mother", 4500, 1277.2, 421.4, 1051, 1051, 0, 73, 73, 0, 4, 1608, 1608, 0, 1608, 73, "Nothing", 0, 10, 10, 10));
        enemies.add(new Enemy("Green dragon", 4500, 198, 65.3, 297, 0, 297, 45, 0, 45, 6, 732, 0, 732, 732, 45, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Cyclops", 4500, 198, 65.3, 180, 0, 0, 45, 0, 0, 5, 732, 0, 0, 732, 45, "Earth", 90, 55, 45, 65));
        enemies.add(new Enemy("Ghoul champion", 4500, 166.8, 55, 918, 918, 0, 50, 50, 0, 5, 850, 850, 0, 850, 50, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Zanik", 4700, 217.8, 71.8, 0, 140, 0, 0, 47, 0, 4, 0, 778, 0, 778, 47, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Kalphite Soldier", 4700, 217.8, 71.8, 188, 0, 0, 47, 0, 0, 4, 778, 0, 0, 778, 47, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Revenant hobgoblin", 4800, 145.2, 47.9, 720, 720, 720, 32, 32, 32, 5, 486, 486, 486, 486, 32, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Agrith-Na-Na", 4800, 327.9, 108.2, 288, 0, 384, 48, 0, 64, 4, 810, 0, 1264, 1264, 64, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Flambeed", 4800, 327.9, 108.2, 384, 0, 0, 64, 0, 0, 4, 1264, 0, 0, 1264, 64, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Karamel", 4800, 327.9, 108.2, 288, 384, 0, 48, 64, 0, 4, 801, 1264, 0, 1264, 64, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Ogre", 4800, 227.7, 75.1, 288, 0, 0, 48, 0, 0, 6, 801, 0, 0, 801, 48, "Air", 90, 55, 45, 65));
        enemies.add(new Enemy("Gelatinnoth Mother", 4875, 344.4, 113.6, 292, 0, 390, 48, 0, 65, 4, 487, 0, 1299, 1299, 65, "Thrown", 90, 45, 65, 55));
        enemies.add(new Enemy("Dessourt", 4950, 361.5, 119.2, 297, 0, 396, 49, 0, 66, 3, 495, 0, 1335, 1335, 66, "Thrown", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Fever spider", 5000, 250.2, 82.5, 150, 200, 0, 27, 50, 0, 4, 375, 850, 0, 850, 50, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Lesser demon", 5000, 250.2, 82.5, 0, 0, 480, 0, 0, 50, 4, 0, 0, 850, 850, 50, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Goblin statue", 5000, 250.2, 82.5, 200, 0, 0, 50, 0, 0, 4, 850, 0, 0, 850, 50, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Ogre statue", 5000, 201.3, 66.4, 216, 0, 0, 54, 0, 0, 4, 955, 0, 0, 955, 54, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Sigmund (ASoH)", 5000, 250.2, 82.5, 240, 0, 0, 50, 0, 0, 4, 850, 0, 0, 850, 50, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Blue dragon", 5000, 263, 86.7, 349, 0, 349, 53, 0, 53, 4, 928, 0, 928, 928, 53, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Revenant vampyre", 5100, 159.6, 52.6, 765, 765, 765, 34, 34, 34, 5, 519, 519, 519, 519, 34, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Ork statue", 5100, 262.3, 86.5, 204, 0, 0, 51, 0, 0, 4, 875, 0, 0, 875, 51, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Ice demon", 5250, 440.7, 145.4, 0, 739, 739, 0, 70, 70, 4, 0, 1486, 1486, 1486, 70, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Exiled kalphite worker", 5400, 301.9, 99.6, 188, 0, 0, 54, 0, 0, 4, 955, 0, 0, 955, 54, "Water", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Aberrant spectre champion", 5500, 269.4, 88.9, 0, 0, 1102, 0, 0, 60, 5, 0, 0, 1132, 1132, 60, "Arrows", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Nial Swiftfling", 5800, 367.2, 121.1, 464, 464, 0, 58, 58, 0, 4, 1070, 1070, 0, 1070, 58, "Nothing", 0, 40, 20, 10));
        enemies.add(new Enemy("Warped terrorbird", 5900, 385.2, 127.1, 177, 236, 0, 32, 59, 0, 4, 442, 1101, 0, 1101, 59, "Slash", 90, 65, 55, 45));
        ...
        enemies.add(new Enemy("Fairy Godfather", 6000, 404.1, 133.3, 0, 240, 0, 0, 60, 0, 8, 0, 1132, 0, 1132, 60, "Nothing", 0, 40, 20, 10));
        enemies.add(new Enemy("Red Axe director", 6000, 344.4, 113.6, 700, 0, 0, 70, 0, 0, 5, 1486, 0, 0, 1132, 60, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Red dragon", 6000, 404, 133.3, 396, 0, 396, 60, 0, 60, 4, 1132, 0, 1132, 1132, 60, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Exiled kalphite paragon", 6000, 404.1, 133.3, 0, 0, 240, 0, 0, 60, 4, 0, 0, 1132, 1132, 60, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Exiled kalphite soldier", 6000, 404.1, 133.3, 240, 0, 0, 60, 0, 0, 4, 1132, 0, 0, 1132, 60, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Jogre champion", 6000, 440.7, 145.4, 1286, 0, 0, 70, 0, 0, 5, 1486, 0, 0, 1486, 70, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Aberrant spectre", 6000, 274.5, 90.5, 0, 0, 208, 0, 0, 52, 4, 0, 0, 901, 901, 52, "Thrown", 90, 45, 65, 55));
        enemies.add(new Enemy("Greater demon", 6000, 385.2, 127.1, 0, 0, 566, 0, 0, 59, 4, 0, 0, 1101, 1101, 59, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Rorarius", 6000, 404.1, 133.3, 0, 0, 576, 0, 0, 60, 5, 0, 0, 1132, 1132, 60, "None", 0, 7, 50, 15));
        ...
        enemies.add(new Enemy("Aviansie", 6400, 491.8, 162.2, 0, 256, 0, 0, 64, 0, 4, 0, 1264, 0, 1264, 64, "Bolts", 90, 45, 55, 60));
        ...
        enemies.add(new Enemy("Arrg", 7000, 317.2, 104.6, 220, 220, 0, 55, 55, 0, 4, 983, 983, 0, 983, 55, "Nothing", 0, 20, 10, 40));
        enemies.add(new Enemy("Bouncer", 7000, 661, 218.1, 168, 0, 0, 70, 0, 0, 2, 1486, 0, 0, 1486, 70, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Culinaromancer", 7000, 661, 218.1, 0, 0, 420, 0, 0, 70, 4, 0, 0, 1486, 1486, 70, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Black dragon", 7000, 714, 235.6, 475, 0, 475, 72, 0, 72, 4, 1566, 0, 1566, 1566, 72, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Aquanite", 7000, 598.5, 197.5, 0, 0, 652, 0, 0, 68, 4, 0, 0, 1409, 1409, 68, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Exiled kalphite guardian", 7000, 661, 218.1, 280, 0, 0, 70, 0, 0, 4, 1486, 0, 0, 1486, 70, "Water", 90, 55, 45, 65));
        enemies.add(new Enemy("Exiled kalphite marauder", 7000, 661, 218.1, 0, 0, 280, 0, 0, 70, 4, 0, 0, 1486, 1486, 70, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Lesser demon champion", 7000, 723.6, 238.7, 1470, 0, 1470, 80, 0, 80, 5, 1924, 0, 1924, 1924, 80, "Thrown", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Automaton Generator (TWW)", 7500, 404.1, 133.3, 0, 0, 600, 0, 0, 60, 8, 0, 0, 1132, 1132, 60, "Nothing", 0, 30, 50, 40));
        ...
        enemies.add(new Enemy("Skogre", 8000, 103.8, 34.2, 240, 0, 0, 40, 0, 0, 6, 628, 0, 0, 628, 40, "Arrows", 90, 55, 45, 65));
        enemies.add(new Enemy("Gladius", 8000, 516.6, 170.4, 0, 0, 624, 0, 0, 65, 5, 0, 0, 1299, 1299, 65, "Nothing", 0, 7, 50, 15));
        enemies.add(new Enemy("Nechyrael", 8000, 628.6, 207.4, 276, 0, 0, 69, 0, 0, 4, 1447, 0, 0, 1447, 69, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Revenant ork", 8250, 661, 218.1, 1237, 1237, 1237, 70, 70, 70, 5, 1486, 1486, 1486, 1486, 70, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Evil Chicken", 8250, 423, 139.5, 440, 0, 0, 55, 0, 0, 4, 983, 0, 0, 983, 55, "Nothing", 0, 20, 10, 40));
        enemies.add(new Enemy("Abyssal demon", 8500, 661, 218.1, 672, 0, 0, 70, 0, 0, 4, 1486, 0, 0, 1608, 70, "Slash", 90, 55, 45, 65));
        enemies.add(new Enemy("Mummy champion", 8580, 564.3, 186.2, 1378, 0, 1378, 75, 0, 75, 5, 1694, 0, 1694, 1694, 75, "Fire", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Black demon", 9000, 661, 218.1, 0, 0, 672, 0, 0, 70, 4, 0, 0, 1486, 1486, 70, "Bolts", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Giant scarab", 10000, 723, 238.5, 198, 264, 0, 49, 66, 0, 4, 495, 1335, 0, 1335, 66, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Phoenix", 10000, 0, 0, 0, 0, 350, 0, 0, 60, 6, 0, 0, 1299, 1132, 60, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Ikadia the Exile", 10000, 1787.4, 589.8, 0, 0, 450, 0, 0, 90, 5, 0, 0, 2458, 2458, 90, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Giant Roc", 10000, 423, 139.5, 220, 220, 0, 55, 55, 0, 4, 983, 983, 0, 983, 55, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Sigmund (TCC)", 10000, 363, 119.7, 360, 0, 0, 47, 0, 0, 4, 778, 0, 0, 778, 47, "Nothing", 0, 40, 40, 40));
        ...
        enemies.add(new Enemy("Torcher", 10000, 0, 0, 0, 0, 240, 0, 0, 50, 4, 0, 0, 850, 850, 50, "Bolts", 90, 45, 65, 55));
        enemies.add(new Enemy("Brawler", 10000, 0, 0, 420, 0, 0, 50, 0, 0, 7, 850, 0, 0, 850, 50, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Shifter", 10000, 0, 0, 0, 240, 0, 0, 50, 0, 4, 0, 850, 0, 850, 50, "Slash", 90, 65, 45, 45));
        enemies.add(new Enemy("Spinner", 10000, 417, 137.6, 240, 0, 0, 50, 0, 0, 4, 850, 0, 0, 850, 50, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("TokTz-Ket-Dill (TTKD)", 10000, 345.7, 114, 685, 0, 0, 46, 0, 0, 6, 755, 0, 0, 755, 46, "Crush", 40, 20, 10, 40));
        enemies.add(new Enemy("Fern", 10000, 50, 16.5, 0, 250, 0, 0, 50, 0, 5, 0, 850, 0, 850, 50, "Crush", 90, 65, 55, 45));
        enemies.add(new Enemy("Sir Owen", 10000, 25, 8.2, 250, 0, 0, 50, 0, 0, 5, 850, 0, 0, 850, 50, "Nothing", 0, 55, 45, 65));
        ...
        enemies.add(new Enemy("Corrupted lizard", 11000, 708, 233.6, 0, 1094, 0, 0, 76, 0, 4, 0, 1738, 0, 1694, 75, "Stab", 90, 65, 55, 45));
        enemies.add(new Enemy("Vyrelord", 11370, 661, 218.1, 0, 0, 672, 0, 0, 70, 4, 0, 0, 1486, 1486, 70, "Nothing", 0, 55, 55, 55));
        ...
        enemies.add(new Enemy("Glod", 12000, 379.5, 125.2, 376, 0, 0, 47, 0, 0, 4, 778, 0, 0, 778, 50, "Nothing", 0, 20, 10, 40));
        ...
        enemies.add(new Enemy("Nezikchened", 15000, 808.2, 266.7, 735, 0, 735, 60, 0, 60, 5, 1132, 0, 1132, 1132, 60, "Nothing", 0, 20, 10, 40));
        enemies.add(new Enemy("Truthful shadow", 15000, 288, 95, 1008, 0, 0, 70, 0, 0, 4, 1694, 0, 0, 1486, 70, "Fire", 90, 55, 45, 65));
        enemies.add(new Enemy("Banshee mistress", 15000, 949.5, 313.3, 201, 0, 268, 50, 0, 67, 4, 850, 0, 1372, 1372, 67, "Bolts", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Glophren", 17400, 1857, 612.8, 0, 0, 1561, 0, 0, 85, 5, 0, 0, 2178, 2178, 85, "Thrown", 90, 45, 65, 55));
        ...
        enemies.add(new Enemy("Sotapanna", 18000, 1289, 425.3, 1966, 0, 0, 88, 0, 0, 6, 2343, 0, 0, 1566, 72, "Air", 90, 55, 45, 65));
        ...
        enemies.add(new Enemy("Arrav", 20000, 0, 0, 672, 0, 0, 65, 0, 0, 4, 1299, 0, 0, 1299, 65, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Giant scarab (Contact!)", 20000, 1040.5, 343.3, 372, 372, 0, 62, 62, 0, 6, 1197, 1197, 0, 1197, 62, "Nothing", 0, 40, 40, 40));
        ...
        enemies.add(new Enemy("Slash Bash", 24000, 171.9, 56.7, 252, 252, 0, 42, 42, 0, 6, 668, 668, 0, 668, 42, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Dawn", 24750, 0, 0, 0, 0, 250, 0, 0, 50, 5, 0, 0, 850, 850, 50, "Nothing", 0, 45, 65, 55));
        ...
        enemies.add(new Enemy("General Khazard", 45000, 0, 0, 0, 0, 787, 0, 0, 75, 7, 0, 0, 1694, 1694, 75, "Nothing", 0, 40, 40, 40));
        ...
        enemies.add(new Enemy("Leeuni", 50000, 3305.2, 1090.7, 1008, 1008, 1008, 70, 70, 70, 4, 1486, 1486, 1486, 1486, 70, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Ayuni", 50000, 3305.2, 1090.7, 1008, 1008, 1008, 70, 70, 70, 4, 1486, 1486, 1486, 1486, 70, "Nothing", 0, 40, 40, 40));
        ...
        enemies.add(new Enemy("Pest Queen", 50000, 6390.1, 2108.7, 1378, 0, 1378, 70, 0, 70, 5, 1486, 0, 1486, 1486, 70, "Nothing", 0, 40, 40, 40));
        ...
        enemies.add(new Enemy("Chaos Grimsson", 60000, 5788.8, 1910.3, 1000, 1000, 0, 85, 85, 0, 6, 2178, 2178, 0, 1924, 75, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Chaos Hreidmar", 60000, 5788.8, 1910.3, 0, 0, 1000, 0, 0, 85, 5, 0, 0, 2178, 1924, 75, "Nothing", 0, 45, 65, 55));
        enemies.add(new Enemy("Horrific Crassian (story)", 62500, 3608.1, 1190.6, 196, 0, 0, 88, 0, 0, 2, 2343, 0, 0, 1132, 60, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Cap'n Ekahi", 65000, 0, 0, 1100, 0, 0, 80, 0, 0, 6, 1924, 0, 0, 1924, 80, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Ol' Sawtooth (story)", 67500, 6024.3, 1988, 197, 0, 0, 88, 0, 0, 4, 2343, 0, 0, 1486, 70, "Nothing", 0, 55, 45, 65));
        ...
        enemies.add(new Enemy("Giant Mole", 78000, 3104, 1024.3, 720, 0, 0, 65, 0, 0, 4, 1299, 0, 0, 732, 45, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Giant Mole (hard)", 78000, 3104, 1024.3, 720, 0, 0, 65, 0, 0, 3, 2178, 0, 0, 732, 45, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Ahoeitu the Chef (story)", 90000, 8321.4, 2746, 197, 0, 0, 88, 0, 0, 6, 2343, 0, 0, 1566, 72, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Arhat Paragon (story)", 90000, 10773, 3555, 0, 0, 158, 0, 0, 95, 4, 0, 0, 2765, 1924, 80, "Nothing", 0, 45, 65, 55));
        enemies.add(new Enemy("Jade the Unruly (story)", 90000, 8321.4, 2746, 197, 0, 0, 88, 0, 0, 6, 2343, 0, 0, 1566, 72, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Goku the Unrelenting (story)", 90000, 8321.4, 2746, 0, 0, 131, 0, 0, 88, 6, 0, 0, 2343, 1566, 72, "Stab", 90, 45, 65, 55));
        enemies.add(new Enemy("Menaphite Guard Captain (story)", 90000, 6075, 2005, 189, 0, 0, 80, 0, 0, 5, 1924, 0, 0, 1694, 75, "Nothing", 0, 55, 55, 55));
        enemies.add(new Enemy("Olivia the Chronicler (story)", 90000, 8321.4, 2746, 0, 0, 131, 0 ,0, 88, 6, 0, 0, 2343, 1566, 72, "Arrows", 90, 45, 65, 55));
        enemies.add(new Enemy("Oyu the Quietest (story)", 90000, 9981.4, 3293.8, 0, 0, 153, 0, 0, 95, 4, 0, 0, 2765, 1694, 75, "Nothing", 0, 45, 65, 55));
        enemies.add(new Enemy("Sarkhan the Serpentspeaker (story)", 90000, 8321.4, 2746, 196, 0, 0, 88, 0, 0, 6, 2343, 0, 0, 1566, 72, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("The Violet Lotus (story)", 90000, 8321.4, 2746, 196, 0, 0, 88, 0, 0, 6, 2343, 0, 0, 1566, 72, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Xiang the Water-shaper (story)", 90000, 8321.4, 2746, 196, 0, 0, 88, 0, 0, 6, 2343, 0, 0, 1566, 72, "Nothing", 0, 55, 45, 65));
        enemies.add(new Enemy("Yukimura of Hanto (story)", 90000, 6912.7, 2281.1, 138, 0, 0, 88, 0, 0, 5, 2343, 0, 0, 1694, 75, "Nothing", 0, 55, 55, 55));
        ...
        enemies.add(new Enemy("General Graardor (hard)", 100000, 16350, 5395.5, 3000, 1500, 0, 75, 75, 0, 5, 1694, 1694, 0, 1694, 75, "Nothing", 0, 60, 70, 50));
        ...
        enemies.add(new Enemy("K'ril Tsutsaroth (hard)", 100000, 7618, 2513.9, 1500, 0, 1500, 75, 0, 75, 4, 1694, 0, 1694, 1694, 75, "Nothing", 0, 70, 80, 60));
        ...
        enemies.add(new Enemy("Vindicta (hard)", 300000, 10000, 3300, 4500, 4500, 0, 80, 80, 0, 5, 2178, 2178, 0, 1924, 80, "Nothing", 0, 50, 50, 50));
        enemies.add(new Enemy("Helwyr (hard)", 300000, 9000, 2970, 1296, 0, 0, 90, 0, 0, 4, 2458, 0, 0, 1694, 75, "Nothing", 0, 40, 40, 40));
        enemies.add(new Enemy("Astellarn", 450000, 0, 0, 1368, 1368, 1368, 95, 95, 95, 4, 2765, 2765, 2765, 2178, 85, "Bane", 90, 55, 55, 55));
        ...
        enemies.add(new Enemy("Vorago (HM)", 2750000, 100000, 33000, 5000, 0, 5000, 90, 0, 90, 4, 2458, 0, 2458, 2178, 90, "Nothing", 0, 40, 40, 40));
