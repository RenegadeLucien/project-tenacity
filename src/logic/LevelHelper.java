...
public class LevelHelper {
    ...
    public static int getLevel(String skill, double skillXp) {
    ...
    public static int getVirtualLevel(String skill, double skillXp) {
        if (skill.equals("Invention")) {
            for (int i = 1; i < XP_TO_LEVELS_ELITE.length; i++) {
                if (skillXp < XP_TO_LEVELS_ELITE[i]) {
                    return i;
    ...
    public static int getXpToLevel(String skill, int level, double xp) {
        if (skill.equals("Invention")) {
            return Math.max(0, XP_TO_LEVELS_ELITE[level - 1] - (int)xp);
        } else {
            return Math.max(0, XP_TO_LEVELS[level - 1] - (int)xp);
        }
    }
